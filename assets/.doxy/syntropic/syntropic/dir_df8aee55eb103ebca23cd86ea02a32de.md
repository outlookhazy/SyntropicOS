...
[**FileList**](files.md) **>** [**port**](dir_df8aee55eb103ebca23cd86ea02a32de.md)
...
| Type | Name |
| ---: | :--- |
| file | [**syn\_port\_adc.h**](syn__port__adc_8h.md) <br>_Port contract for Analog-to-Digital Converter (ADC) hardware._  |
| file | [**syn\_port\_aes.h**](syn__port__aes_8h.md) <br>_AES / GCM hardware acceleration port interface._  |
| file | [**syn\_port\_ble\_hci.h**](syn__port__ble__hci_8h.md) <br>_Port Abstraction Header for Bluetooth HCI Transport (UART H:4 / SPI)._  |
| file | [**syn\_port\_can.h**](syn__port__can_8h.md) <br>_CAN bus port interface._  |
| file | [**syn\_port\_comp.h**](syn__port__comp_8h.md) <br>_Platform Port Interface for Analog Comparators._  |
| file | [**syn\_port\_dac.h**](syn__port__dac_8h.md) <br>_Platform port: Digital-to-Analog Converter (DAC)._  |
| file | [**syn\_port\_dma.h**](syn__port__dma_8h.md) <br>_Hardware port abstraction interface for DMA controller._  |
...
| file | [**syn\_port\_hpclock.h**](syn__port__hpclock_8h.md) <br>_High-precision clock port interface — implement for your platform._  |
| file | [**syn\_port\_hrpwm.h**](syn__port__hrpwm_8h.md) <br>_Platform Port Interface for High-Resolution PWM & Power Driver._  |
| file | [**syn\_port\_i2c.h**](syn__port__i2c_8h.md) <br>_Port contract for Inter-Integrated Circuit (I2C) hardware._  |
...
| file | [**syn\_port\_spi.h**](syn__port__spi_8h.md) <br>_Port contract for Serial Peripheral Interface (SPI) hardware._  |
