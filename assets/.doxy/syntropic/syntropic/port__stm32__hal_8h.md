...
| Type | Name |
| ---: | :--- |
|  [**SYN\_Status**](syn__defs_8h.md#enum-syn_status) | [**syn\_port\_stm32\_register\_cryp**](#function-syn_port_stm32_register_cryp) (void \* hcryp) <br>_Register an STM32 HAL CRYP\_HandleTypeDef pointer (e.g. &hcryp) with SyntropicOS hardware crypto accelerator port._  |
...
### function syn\_port\_stm32\_register\_cryp 

_Register an STM32 HAL CRYP\_HandleTypeDef pointer (e.g. &hcryp) with SyntropicOS hardware crypto accelerator port._ 
```C++
SYN_Status syn_port_stm32_register_cryp (
    void * hcryp
) 
```
...
* `hcryp` Pointer to STM32 HAL CRYP\_HandleTypeDef (or NULL to unregister). 
