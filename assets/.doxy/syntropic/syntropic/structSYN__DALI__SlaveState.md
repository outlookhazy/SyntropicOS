...
|  [**bool**](syn__defs_8h.md#enum-bool) | [**dapc\_sequence\_active**](#variable-dapc_sequence_active)  <br> |
...
Persistent slave configuration settings 
...
### variable dapc\_sequence\_active 

```C++
bool SYN_DALI_SlaveState::dapc_sequence_active;
```
