...
# Struct SYN\_HMAC\_SHA512



[**ClassList**](annotated.md) **>** [**SYN\_HMAC\_SHA512**](structSYN__HMAC__SHA512.md)



_HMAC-SHA512 context — caller-owned._ 
...
```C++
SYN_SHA512 SYN_HMAC_SHA512::inner;
```
...
```C++
uint8_t SYN_HMAC_SHA512::o_key_pad[SYN_SHA512_BLOCK_SIZE];
```
