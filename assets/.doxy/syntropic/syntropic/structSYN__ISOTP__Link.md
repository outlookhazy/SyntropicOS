...
|  uint8\_t | [**rx\_bs\_count**](#variable-rx_bs_count)  <br> |
...
### variable rx\_bs\_count 

```C++
uint8_t SYN_ISOTP_Link::rx_bs_count;
```



Received frame counter in current block 
...
```C++
uint8_t SYN_ISOTP_Link::rx_fc_bs;
```



Flow Control Block Size to transmit (default 8) 
...
### variable rx\_fc\_stmin 

```C++
uint8_t SYN_ISOTP_Link::rx_fc_stmin;
```



Flow Control STmin to transmit (default 0) 
