...
|  [**bool**](syn__defs_8h.md#enum-bool) | [**has\_active\_slot**](#variable-has_active_slot)  <br> |
...
### variable has\_active\_slot 

```C++
bool SYN_ParamStore::has_active_slot;
```



Flash has at least one valid saved slot 
