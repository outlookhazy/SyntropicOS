...
| Type | Name |
| ---: | :--- |
|  uint8\_t | [**base\_priority**](#variable-base_priority)  <br> |
...
|  volatile uint8\_t | [**state**](#variable-state)  <br> |
...
### variable base\_priority 

```C++
uint8_t SYN_Task::base_priority;
```
...
```C++
volatile uint8_t SYN_Task::state;
```
