...
The user allocates this struct (stack or static) and passes it to [**syn\_uart\_init()**](syn__uart_8c.md#function-syn_uart_init) or [**syn\_uart\_init\_config()**](syn__uart_8c.md#function-syn_uart_init_config). The backing buffers are embedded so no dynamic allocation is needed. 
...
```C++
bool SYN_UART::use_dma;
```



Per-instance DMA enablement flag 
