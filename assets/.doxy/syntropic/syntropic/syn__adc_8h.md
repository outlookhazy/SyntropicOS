...
_General-purpose multi-channel ADC driver — single-shot and DMA background scanning._ 
...
| Type | Name |
| ---: | :--- |
| struct | [**SYN\_ADC**](structSYN__ADC.md) <br>_ADC driver handle structure._  |
| struct | [**SYN\_ADC\_Config**](structSYN__ADC__Config.md) <br>_ADC driver configuration structure._  |
