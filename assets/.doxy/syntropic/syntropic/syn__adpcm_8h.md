...
[**FileList**](files.md) **>** [**audio**](dir_716e324b7bf36f9621c6c050b7298dab.md) **>** [**syn\_adpcm.h**](syn__adpcm_8h.md)

[Go to the source code of this file](syn__adpcm_8h_source.md)

_IMA/DVI ADPCM Speech and Audio Codec (Encoder & Decoder)._ [More...](#detailed-description)
...
| Type | Name |
| ---: | :--- |
| struct | [**SYN\_ADPCM\_State**](structSYN__ADPCM__State.md) <br>_IMA-ADPCM Encoder and Decoder State._  |
...
Implements a lightweight, zero-heap, integer-only IMA-ADPCM codec. Achieves 4:1 compression ratio (16-bit linear PCM &lt;-&gt; 4-bit ADPCM nibbles). Fully compatible with standard WAV IMA-ADPCM files and tools (ffmpeg, Audacity).
