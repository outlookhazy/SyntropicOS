...
[**FileList**](files.md) **>** [**proto**](dir_0a7333506e1b11c22e7531106607b850.md) **>** [**syn\_at\_parser.h**](syn__at__parser_8h.md)

[Go to the source code of this file](syn__at__parser_8h_source.md)

_Zero-allocation, stream-oriented AT command parser for cellular & serial modems._ [More...](#detailed-description)
...
| Type | Name |
| ---: | :--- |
| struct | [**SYN\_AtParser**](structSYN__AtParser.md) <br>_AT Command Parser context._  |
...
| Type | Name |
| ---: | :--- |
| enum  | [**SYN\_AtRespType**](#enum-syn_atresptype)  <br>_Decoded AT response types._  |
...
Lightweight, non-blocking line and prompt parser for modems (SIM800, Quectel, ESP-AT, etc.). Feeds from [**SYN\_Stream**](structSYN__Stream.md) or raw byte feeds, handles CRLF line framing, prompt '&gt;' detection, CME ERROR decoding, URC filtering, and parameter extraction without dynamic memory allocation.
...
### enum SYN\_AtRespType 

_Decoded AT response types._ 
```C++
enum SYN_AtRespType {
    SYN_AT_RESP_NONE = 0,
    SYN_AT_RESP_OK,
