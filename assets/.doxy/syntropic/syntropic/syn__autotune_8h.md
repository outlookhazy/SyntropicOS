...
|  void | [**syn\_autotune\_calc\_relay\_gains**](#function-syn_autotune_calc_relay_gains) (int32\_t Ku, uint32\_t Tu\_ms, [**SYN\_AutoTune\_Method**](syn__autotune_8h.md#enum-syn_autotune_method) method, uint16\_t multiplier\_pct, int32\_t \* kp, int32\_t \* ki, int32\_t \* kd) <br>_Calculate Ziegler-Nichols / Tyreus-Luyben PID gains from ultimate gain (Ku) and period (Tu\_ms)._  |
...
### function syn\_autotune\_calc\_relay\_gains 

_Calculate Ziegler-Nichols / Tyreus-Luyben PID gains from ultimate gain (Ku) and period (Tu\_ms)._ 
```C++
...
* `Ku` Ultimate gain (scaled by pid\_scale). 
