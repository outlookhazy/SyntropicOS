...
| struct | [**SYN\_FilterBiquadCascade**](structSYN__FilterBiquadCascade.md) <br>_Multi-stage cascaded biquad filter structure for high-order filtering._  |
...
| Type | Name |
| ---: | :--- |
| define  | [**SYN\_BIQUAD\_CASCADE\_MAX\_STAGES**](syn__biquad_8h.md#define-syn_biquad_cascade_max_stages)  `8`<br> |
...
### define SYN\_BIQUAD\_CASCADE\_MAX\_STAGES 
...
Maximum allowed biquad filter stages in cascade 
