...
| Type | Name |
| ---: | :--- |
| struct | [**SYN\_Button**](structSYN__Button.md) <br>_Button descriptor — owns the FSM, debounce, multi-click, and callback state._  |
| struct | [**SYN\_ButtonCombo**](structSYN__ButtonCombo.md) <br>_Combination button descriptor for simultaneous multi-button presses._  |
...
| Type | Name |
| ---: | :--- |
|  void | [**syn\_button\_combo\_init**](#function-syn_button_combo_init) ([**SYN\_ButtonCombo**](structSYN__ButtonCombo.md) \* combo, const [**SYN\_Button**](structSYN__Button.md) \*\* buttons, size\_t count, [**SYN\_ButtonCallback**](syn__button_8h.md#typedef-syn_buttoncallback) cb, void \* ctx) <br>_Initialize a combination button descriptor._  |
|  void | [**syn\_button\_combo\_update**](#function-syn_button_combo_update) ([**SYN\_ButtonCombo**](structSYN__ButtonCombo.md) \* combo) <br>_Update a combination button descriptor._  |
...
|  void | [**syn\_button\_on\_double\_click**](#function-syn_button_on_double_click) ([**SYN\_Button**](structSYN__Button.md) \* btn, [**SYN\_ButtonCallback**](syn__button_8h.md#typedef-syn_buttoncallback) cb, void \* ctx) <br>_Register a double-click callback._  |
...
|  void | [**syn\_button\_on\_multi\_click**](#function-syn_button_on_multi_click) ([**SYN\_Button**](structSYN__Button.md) \* btn, [**SYN\_ButtonCallback**](syn__button_8h.md#typedef-syn_buttoncallback) cb, void \* ctx) <br>_Register a multi-click (4+ taps) callback._  |
...
|  void | [**syn\_button\_on\_single\_click**](#function-syn_button_on_single_click) ([**SYN\_Button**](structSYN__Button.md) \* btn, [**SYN\_ButtonCallback**](syn__button_8h.md#typedef-syn_buttoncallback) cb, void \* ctx) <br>_Register a single-click callback._  |
|  void | [**syn\_button\_on\_triple\_click**](#function-syn_button_on_triple_click) ([**SYN\_Button**](structSYN__Button.md) \* btn, [**SYN\_ButtonCallback**](syn__button_8h.md#typedef-syn_buttoncallback) cb, void \* ctx) <br>_Register a triple-click callback._  |
...
|  void | [**syn\_button\_set\_click\_window**](#function-syn_button_set_click_window) ([**SYN\_Button**](structSYN__Button.md) \* btn, uint16\_t window\_ms) <br>_Set the multi-click evaluation window in milliseconds._  |
...
| Type | Name |
| ---: | :--- |
|  uint8\_t | [**syn\_button\_clicks**](#function-syn_button_clicks) (const [**SYN\_Button**](structSYN__Button.md) \* btn) <br>_Get the consecutive click count._  |
|  [**bool**](syn__defs_8h.md#enum-bool) | [**syn\_button\_combo\_is\_active**](#function-syn_button_combo_is_active) (const [**SYN\_ButtonCombo**](structSYN__ButtonCombo.md) \* combo) <br>_Is the combination button currently active (all buttons held)?_  |
...
| Type | Name |
| ---: | :--- |
| define  | [**PT\_BUTTON\_BLOCK\_PRESS**](syn__button_8h.md#define-pt_button_block_press) (pt, task, btn) `/* multi line expression */`<br> |
| define  | [**PT\_BUTTON\_BLOCK\_RELEASE**](syn__button_8h.md#define-pt_button_block_release) (pt, task, btn) `/* multi line expression */`<br> |
...
| define  | [**SYN\_BUTTON\_EVT\_DOUBLE\_CLICK**](syn__button_8h.md#define-syn_button_evt_double_click)  `((uint8\_t)(1u &lt;&lt; 5))`<br> |
| define  | [**SYN\_BUTTON\_EVT\_LONG\_PRESS**](syn__button_8h.md#define-syn_button_evt_long_press)  `((uint8\_t)(1u &lt;&lt; 2))`<br> |
| define  | [**SYN\_BUTTON\_EVT\_MULTI\_CLICK**](syn__button_8h.md#define-syn_button_evt_multi_click)  `((uint8\_t)(1u &lt;&lt; 7))`<br> |
...
| define  | [**SYN\_BUTTON\_EVT\_SINGLE\_CLICK**](syn__button_8h.md#define-syn_button_evt_single_click)  `((uint8\_t)(1u &lt;&lt; 4))`<br> |
| define  | [**SYN\_BUTTON\_EVT\_TRIPLE\_CLICK**](syn__button_8h.md#define-syn_button_evt_triple_click)  `((uint8\_t)(1u &lt;&lt; 6))`<br> |
...
### function syn\_button\_combo\_init 

_Initialize a combination button descriptor._ 
```C++
...
* `buttons` Array of pointers to initialized [**SYN\_Button**](structSYN__Button.md) descriptors. 
...
### function syn\_button\_combo\_update 

_Update a combination button descriptor._ 
```C++
...
### function syn\_button\_on\_double\_click 

_Register a double-click callback._ 
```C++
...
### function syn\_button\_on\_multi\_click 

_Register a multi-click (4+ taps) callback._ 
```C++
...
### function syn\_button\_on\_single\_click 

_Register a single-click callback._ 
```C++
...
### function syn\_button\_on\_triple\_click 

_Register a triple-click callback._ 
```C++
...
### function syn\_button\_set\_click\_window 

_Set the multi-click evaluation window in milliseconds._ 
```C++
...
### function syn\_button\_clicks 

_Get the consecutive click count._ 
```C++
...
### function syn\_button\_combo\_is\_active 

_Is the combination button currently active (all buttons held)?_ 
```C++
...
### define PT\_BUTTON\_BLOCK\_PRESS 

```C++
#define PT_BUTTON_BLOCK_PRESS (
    pt,
    task,
    btn
...
Block task execution (SYN\_TASK\_BLOCKED) until the button is pressed (debounced). 
...
### define PT\_BUTTON\_BLOCK\_RELEASE 

```C++
#define PT_BUTTON_BLOCK_RELEASE (
    pt,
    task,
    btn
) `/* multi line expression */`
...
Block task execution (SYN\_TASK\_BLOCKED) until the button is released. 
...
### define SYN\_BUTTON\_EVT\_DOUBLE\_CLICK 
...
### define SYN\_BUTTON\_EVT\_MULTI\_CLICK 
...
### define SYN\_BUTTON\_EVT\_SINGLE\_CLICK 
...
### define SYN\_BUTTON\_EVT\_TRIPLE\_CLICK 
