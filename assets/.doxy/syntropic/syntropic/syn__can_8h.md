...
| struct | [**SYN\_CAN\_Frame**](structSYN__CAN__Frame.md) <br>_CAN bus frame — standard/extended ID, classic CAN or CAN FD._  |
...
| Type | Name |
| ---: | :--- |
| define  | [**SYN\_CAN\_MAX\_DATA\_LEN**](syn__can_8h.md#define-syn_can_max_data_len)  `8U`<br> |
...
### define SYN\_CAN\_MAX\_DATA\_LEN 
