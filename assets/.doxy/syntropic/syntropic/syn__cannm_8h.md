...
[**FileList**](files.md) **>** [**proto**](dir_0a7333506e1b11c22e7531106607b850.md) **>** [**syn\_cannm.h**](syn__cannm_8h.md)

[Go to the source code of this file](syn__cannm_8h_source.md)

_AUTOSAR CAN Network Management (CanNm) Protocol._ [More...](#detailed-description)
...
| Type | Name |
| ---: | :--- |
| struct | [**SYN\_CanNM\_Config**](structSYN__CanNM__Config.md) <br>_AUTOSAR CAN Network Management Configuration._  |
| struct | [**SYN\_CanNM\_Session**](structSYN__CanNM__Session.md) <br>_AUTOSAR CAN Network Management Session Context._  |
...
| Type | Name |
| ---: | :--- |
| enum  | [**SYN\_CanNM\_State**](#enum-syn_cannm_state)  <br>_AUTOSAR CAN Network Management States._  |
...
Implements AUTOSAR CAN Network Management non-blocking state machine for ECU sleep/wake coordination over CAN bus. 
...
### enum SYN\_CanNM\_State 

_AUTOSAR CAN Network Management States._ 
```C++
enum SYN_CanNM_State {
