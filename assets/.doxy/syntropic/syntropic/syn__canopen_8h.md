...
| struct | [**SYN\_CANOpenSDOSession**](structSYN__CANOpenSDOSession.md) <br>_Active SDO transfer session tracking._  |
...
| Type | Name |
| ---: | :--- |
| enum  | [**SYN\_CANOpenSDOState**](#enum-syn_canopensdostate)  <br>_SDO transfer state machine state._  |
...
|  [**SYN\_Status**](syn__defs_8h.md#enum-syn_status) | [**syn\_canopen\_tpdo\_trigger**](#function-syn_canopen_tpdo_trigger) ([**SYN\_CANOpenNode**](structSYN__CANOpenNode.md) \* node, uint8\_t pdo\_num) <br>_Manually trigger transmission of a specific TPDO (1..4)._  |
...
### enum SYN\_CANOpenSDOState 

_SDO transfer state machine state._ 
```C++
...
### function syn\_canopen\_tpdo\_trigger 

_Manually trigger transmission of a specific TPDO (1..4)._ 
```C++
...
SYN\_OK on success, SYN\_INVALID\_PARAM if pdo\_num invalid or unmapped. 
