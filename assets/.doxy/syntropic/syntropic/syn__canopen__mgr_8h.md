...
[**FileList**](files.md) **>** [**proto**](dir_0a7333506e1b11c22e7531106607b850.md) **>** [**syn\_canopen\_mgr.h**](syn__canopen__mgr_8h.md)

[Go to the source code of this file](syn__canopen__mgr_8h_source.md)

_CANopen CiA 302 Network Manager, SDO Client & NMT Master._ [More...](#detailed-description)
...
| Type | Name |
| ---: | :--- |
| struct | [**SYN\_CANOpenManager**](structSYN__CANOpenManager.md) <br>_CANopen Manager Master State Handle._  |
| struct | [**SYN\_CANOpenNodeMonitor**](structSYN__CANOpenNodeMonitor.md) <br>_Remote Node Heartbeat Monitor Entry._  |
| struct | [**SYN\_CANOpenSDOClient**](structSYN__CANOpenSDOClient.md) <br>_SDO Client Transaction Handle._  |
...
| Type | Name |
| ---: | :--- |
| enum  | [**SYN\_SDOClientState**](#enum-syn_sdoclientstate)  <br>_SDO Client Transfer States._  |
...
Provides a lightweight, non-blocking CANopen master engine capable of transmitting NMT node control commands, executing expedited/segmented SDO reads & writes to remote slave nodes, and monitoring network heartbeats. 
...
### enum SYN\_SDOClientState 

_SDO Client Transfer States._ 
```C++
enum SYN_SDOClientState {
