...
| Type | Name |
| ---: | :--- |
|  void | [**syn\_canvas\_arc**](#function-syn_canvas_arc) ([**SYN\_Canvas**](structSYN__Canvas.md) \* c, int16\_t cx, int16\_t cy, int16\_t r, int16\_t start\_angle\_deg, int16\_t end\_angle\_deg, uint16\_t color) <br>_Draw a circular arc._  |
...
|  void | [**syn\_canvas\_line\_aa**](#function-syn_canvas_line_aa) ([**SYN\_Canvas**](structSYN__Canvas.md) \* c, int16\_t x0, int16\_t y0, int16\_t x1, int16\_t y1, uint16\_t color) <br>_Draw an anti-aliased line segment using Xiaolin Wu's algorithm._  |
|  void | [**syn\_canvas\_line\_polar**](#function-syn_canvas_line_polar) ([**SYN\_Canvas**](structSYN__Canvas.md) \* c, int16\_t cx, int16\_t cy, int16\_t angle\_deg, int16\_t length, uint16\_t color) <br>_Draw a line segment defined by origin, angle, and length (gauge needle helper)._  |
...
### function syn\_canvas\_arc 

_Draw a circular arc._ 
```C++
void syn_canvas_arc (
    SYN_Canvas * c,
    int16_t cx,
...
### function syn\_canvas\_line\_aa 

_Draw an anti-aliased line segment using Xiaolin Wu's algorithm._ 
```C++
...
### function syn\_canvas\_line\_polar 

_Draw a line segment defined by origin, angle, and length (gauge needle helper)._ 
```C++
