...
[**File List**](files.md) **>** [**display**](dir_572b98f20fe1ab62e971e24ddc7f0bdb.md) **>** [**syn\_canvas.c**](syn__canvas_8c.md)

[Go to the documentation of this file](syn__canvas_8c.md)
...
{
    if (x < c->clip_x || x >= c->clip_x + c->clip_w)
        return;
...
static void draw_rounded_corners(SYN_Canvas *c, int16_t x, int16_t y, int16_t w, int16_t h,
