...
|  [**bool**](syn__defs_8h.md#enum-bool) | [**syn\_aead\_decrypt\_inplace**](#function-syn_aead_decrypt_inplace) (const uint8\_t key, const uint8\_t nonce, const uint8\_t \* aad, size\_t aad\_len, uint8\_t \* buf, size\_t len, const uint8\_t tag) <br>_Zero-copy in-place AEAD decryption & tag verification._  |
...
|  void | [**syn\_aead\_encrypt\_inplace**](#function-syn_aead_encrypt_inplace) (const uint8\_t key, const uint8\_t nonce, const uint8\_t \* aad, size\_t aad\_len, uint8\_t \* buf, size\_t len, uint8\_t tag) <br>_Zero-copy in-place AEAD encryption._  |
...
|  uint32\_t | [**load32\_le**](#function-load32_le) (const uint8\_t \* p) <br>_Load 32-bit little-endian word from buffer._  |
...
|  void | [**store32\_le**](#function-store32_le) (uint8\_t \* p, uint32\_t v) <br>_Store 32-bit little-endian word to buffer._  |
...
### function syn\_aead\_decrypt\_inplace 

_Zero-copy in-place AEAD decryption & tag verification._ 
```C++
...
### function syn\_aead\_encrypt\_inplace 

_Zero-copy in-place AEAD encryption._ 
```C++
...
_Load 32-bit little-endian word from buffer._ 
```C++
...
* `p` Pointer to source byte buffer. 
...
_Store 32-bit little-endian word to buffer._ 
```C++
...
* `p` Pointer to destination byte buffer. 
* `v` Value to encode. 
