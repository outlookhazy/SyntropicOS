...
| Type | Name |
| ---: | :--- |
|  [**SYN\_ErrLog**](structSYN__ErrLog.md) \* | [**s\_cli\_errlog**](#variable-s_cli_errlog)   = `NULL`<br> |
|  [**SYN\_Sched**](structSYN__Sched.md) \* | [**s\_cli\_sched**](#variable-s_cli_sched)   = `NULL`<br> |
...
|  void | [**cli\_putchar**](#function-cli_putchar) (const [**SYN\_CLI**](structSYN__CLI.md) \* cli, char ch) <br>_Emit a single character via the CLI output._  |
|  void | [**cli\_puts**](#function-cli_puts) (const [**SYN\_CLI**](structSYN__CLI.md) \* cli, const char \* str) <br>_Emit a null-terminated string via the CLI output._  |
...
```C++
SYN_ErrLog* s_cli_errlog;
```



Error log instance for 'errors' command. 
...
```C++
SYN_Sched* s_cli_sched;
```



Scheduler for 'tasks' command. 
...
_Emit a single character via the CLI output._ 
```C++
...
_Emit a null-terminated string via the CLI output._ 
```C++
