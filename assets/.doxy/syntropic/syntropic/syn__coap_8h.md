...
| Type | Name |
| ---: | :--- |
| struct | [**SYN\_CoapBlock**](structSYN__CoapBlock.md) <br>_CoAP Blockwise Transfer Parameter (RFC 7959)._  |
...
| struct | [**SYN\_CoapTransportRequest**](structSYN__CoapTransportRequest.md) <br>_CoAP request context over generic_ [_**SYN\_Transport**_](structSYN__Transport.md) _(e.g. DTLS 1.3 / UDP / Serial)._ |
| struct | [**SYN\_CoapsClient**](structSYN__CoapsClient.md) <br>_CoAP over DTLS 1.3 Client Session (RFC 7252 Section 12.1.2 & RFC 9147)._  |
