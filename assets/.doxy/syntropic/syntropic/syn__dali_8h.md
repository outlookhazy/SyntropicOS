...
| Type | Name |
| ---: | :--- |
| define  | [**SYN\_DALI\_CMD\_ADD\_TO\_GROUP\_BASE**](syn__dali_8h.md#define-syn_dali_cmd_add_to_group_base)  `0x60U`<br> |
| define  | [**SYN\_DALI\_CMD\_DOWN**](syn__dali_8h.md#define-syn_dali_cmd_down)  `0x02U`<br> |
| define  | [**SYN\_DALI\_CMD\_ENABLE\_DAPC\_SEQUENCE**](syn__dali_8h.md#define-syn_dali_cmd_enable_dapc_sequence)  `0x09U`<br> |
| define  | [**SYN\_DALI\_CMD\_ENABLE\_WRITE\_MEMORY**](syn__dali_8h.md#define-syn_dali_cmd_enable_write_memory)  `0x81U`<br> |
| define  | [**SYN\_DALI\_CMD\_GO\_TO\_SCENE\_BASE**](syn__dali_8h.md#define-syn_dali_cmd_go_to_scene_base)  `0x10U`<br> |
...
| define  | [**SYN\_DALI\_CMD\_REMOVE\_FROM\_GROUP\_BASE**](syn__dali_8h.md#define-syn_dali_cmd_remove_from_group_base)  `0x70U`<br> |
| define  | [**SYN\_DALI\_CMD\_REMOVE\_FROM\_SCENE\_BASE**](syn__dali_8h.md#define-syn_dali_cmd_remove_from_scene_base)  `0x50U`<br> |
...
| define  | [**SYN\_DALI\_CMD\_STORE\_DTR\_AS\_SCENE\_BASE**](syn__dali_8h.md#define-syn_dali_cmd_store_dtr_as_scene_base)  `0x40U`<br> |
...
| define  | [**SYN\_DALI\_SPEC\_COMPARE**](syn__dali_8h.md#define-syn_dali_spec_compare)  `0xA9U`<br> |
...
| define  | [**SYN\_DALI\_SPEC\_INITIALISE**](syn__dali_8h.md#define-syn_dali_spec_initialise)  `0xA5U`<br> |
| define  | [**SYN\_DALI\_SPEC\_PROGRAM\_SHORT\_ADDR**](syn__dali_8h.md#define-syn_dali_spec_program_short_addr)  `0xB7U`<br> |
| define  | [**SYN\_DALI\_SPEC\_QUERY\_SHORT\_ADDR**](syn__dali_8h.md#define-syn_dali_spec_query_short_addr)  `0xBBU`<br> |
| define  | [**SYN\_DALI\_SPEC\_RANDOMISE**](syn__dali_8h.md#define-syn_dali_spec_randomise)  `0xA7U`<br> |
| define  | [**SYN\_DALI\_SPEC\_SEARCHADDRH**](syn__dali_8h.md#define-syn_dali_spec_searchaddrh)  `0xB1U`<br> |
| define  | [**SYN\_DALI\_SPEC\_SEARCHADDRL**](syn__dali_8h.md#define-syn_dali_spec_searchaddrl)  `0xB5U`<br> |
| define  | [**SYN\_DALI\_SPEC\_SEARCHADDRM**](syn__dali_8h.md#define-syn_dali_spec_searchaddrm)  `0xB3U`<br> |
| define  | [**SYN\_DALI\_SPEC\_TERMINATE**](syn__dali_8h.md#define-syn_dali_spec_terminate)  `0xA1U`<br> |
| define  | [**SYN\_DALI\_SPEC\_VERIFY\_SHORT\_ADDR**](syn__dali_8h.md#define-syn_dali_spec_verify_short_addr)  `0xB9U`<br> |
| define  | [**SYN\_DALI\_SPEC\_WITHDRAW**](syn__dali_8h.md#define-syn_dali_spec_withdraw)  `0xABU`<br> |
...
```C++
#define SYN_DALI_CMD_ADD_TO_GROUP_BASE `0x60U`
```



Base for Add to Group 0..15 (0x60..0x6F) 
...
### define SYN\_DALI\_CMD\_ENABLE\_DAPC\_SEQUENCE 
...
```C++
#define SYN_DALI_CMD_GO_TO_SCENE_BASE `0x10U`
```



Base command for Go To Scene 0..15 (0x10..0x1F) \ 
...
Query random address high byte 
...
Query random address middle byte 
...
Query system failure level setting 
...
```C++
#define SYN_DALI_CMD_REMOVE_FROM_GROUP_BASE `0x70U`
```



Base for Remove from Group 0..15 (0x70..0x7F) 
...
```C++
#define SYN_DALI_CMD_REMOVE_FROM_SCENE_BASE `0x50U`
```



Base for Remove from Scene 0..15 (0x50..0x5F) 
...
Reset control gear parameters to defaults 
...
Store current actual level in DTR 
...
```C++
#define SYN_DALI_CMD_STORE_DTR_AS_SCENE_BASE `0x40U`
```



Base for Store DTR as Scene 0..15 (0x40..0x4F) 
...
Special command Compare address search 
...
Special command Data Transfer Register 0 
...
Special command Data Transfer Register 1 
...
Special command Data Transfer Register 2 
...
Special command Initialise addressing 
...
Special command Program short address 
...
Special command Query short address 
...
Special command Randomise address 
...
Special command Search address high 
...
Special command Search address low 
...
Special command Search address middle 
...
Special command Terminate addressing 
...
Special command Verify short address 
...
Special command Withdraw from search 
