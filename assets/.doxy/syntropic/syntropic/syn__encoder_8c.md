...
| Type | Name |
| ---: | :--- |
|  const int8\_t | [**quad\_table**](#variable-quad_table)   = `/* multi line expression */`<br>_Quadrature state machine lookup table._  |
...
_Quadrature state machine lookup table._ 
```C++
...
Index = (prev\_state &lt;&lt; 2) \| new\_state. Value = direction: +1 = CW, -1 = CCW, 0 = invalid/no change. 
