...
[**FileList**](files.md) **>** [**src**](dir_68267d1309a1af8e8297ef4c3efbcdba.md) **>** [**syntropic**](dir_d9e327fea148db8a6993543717219dae.md) **>** [**system**](dir_e076fcb374a73e741803d1638643d902.md) **>** [**syn\_errlog.h**](syn__errlog_8h.md)

[Go to the source code of this file](syn__errlog_8h_source.md)

_Persistent error registry — survives resets via param store._ [More...](#detailed-description)
...
| Type | Name |
| ---: | :--- |
| struct | [**SYN\_ErrEntry**](structSYN__ErrEntry.md) <br>_Error log entry — code + severity + context + timestamps._  |
| struct | [**SYN\_ErrLog**](structSYN__ErrLog.md) <br>_Error log instance — circular buffer of error entries._  |
...
| Type | Name |
| ---: | :--- |
| enum  | [**SYN\_ErrSeverity**](#enum-syn_errseverity)  <br>_Error severity levels._  |
...
| Type | Name |
| ---: | :--- |
|  size\_t | [**syn\_errlog\_available**](#function-syn_errlog_available) (const [**SYN\_ErrLog**](structSYN__ErrLog.md) \* log) <br>_Number of entries currently available for reading._  |
|  size\_t | [**syn\_errlog\_count**](#function-syn_errlog_count) (const [**SYN\_ErrLog**](structSYN__ErrLog.md) \* log) <br>_Total errors ever recorded (including overwritten)._  |
|  void | [**syn\_errlog\_enable**](#function-syn_errlog_enable) ([**SYN\_ErrLog**](structSYN__ErrLog.md) \* log, [**bool**](syn__defs_8h.md#enum-bool) en) <br>_Enable/disable recording._  |
...
Records errors with code, timestamp, boot count, and optional context. Stored in flash via syn\_param so they survive power cycles. Can be queried via CLI for field diagnostics.
...
### enum SYN\_ErrSeverity 

_Error severity levels._ 
```C++
enum SYN_ErrSeverity {
    SYN_ERR_INFO = 0,
    SYN_ERR_WARNING = 1,
    SYN_ERR_ERROR = 2,
    SYN_ERR_FATAL = 3
...
### function syn\_errlog\_available 

_Number of entries currently available for reading._ 
```C++
static inline size_t syn_errlog_available (
    const SYN_ErrLog * log
) 
```
...
### function syn\_errlog\_count 

_Total errors ever recorded (including overwritten)._ 
```C++
static inline size_t syn_errlog_count (
    const SYN_ErrLog * log
) 
```
...
### function syn\_errlog\_enable 

_Enable/disable recording._ 
```C++
static inline void syn_errlog_enable (
    SYN_ErrLog * log,
    bool en
) 
```
