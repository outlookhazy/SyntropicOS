...
| struct | [**SYN\_EcatDatagramResult**](structSYN__EcatDatagramResult.md) <br>_Parsed datagram item from frame iteration._  |
| struct | [**SYN\_EcatFMMUConfig**](structSYN__EcatFMMUConfig.md) <br>_EtherCAT FMMU Configuration._  |
| struct | [**SYN\_EcatHeader**](structSYN__EcatHeader.md) <br>_Raw EtherCAT Header (2 bytes)_  |
| struct | [**SYN\_EcatMaster**](structSYN__EcatMaster.md) <br>_EtherCAT Master Instance Context (Zero-Heap)._  |
| struct | [**SYN\_EcatNode**](structSYN__EcatNode.md) <br>_EtherCAT Node Descriptor._  |
| struct | [**SYN\_EcatSMConfig**](structSYN__EcatSMConfig.md) <br>_EtherCAT SyncManager Configuration._  |
| struct | [**SYN\_EcatSlaveInfo**](structSYN__EcatSlaveInfo.md) <br>_EtherCAT Slave Information Entry._  |
...
| Type | Name |
| ---: | :--- |
| define  | [**SYN\_ECAT\_MAX\_SLAVES**](syn__ethercat_8h.md#define-syn_ecat_max_slaves)  `16U`<br> |
| define  | [**SYN\_ESC\_REG\_AL\_CONTROL**](syn__ethercat_8h.md#define-syn_esc_reg_al_control)  `0x0120U`<br> |
| define  | [**SYN\_ESC\_REG\_AL\_STATUS**](syn__ethercat_8h.md#define-syn_esc_reg_al_status)  `0x0130U`<br> |
| define  | [**SYN\_ESC\_REG\_AL\_STATUS\_CODE**](syn__ethercat_8h.md#define-syn_esc_reg_al_status_code)  `0x0134U`<br> |
| define  | [**SYN\_ESC\_REG\_DC\_SYNC0\_CYCLE**](syn__ethercat_8h.md#define-syn_esc_reg_dc_sync0_cycle)  `0x09A0U`<br> |
| define  | [**SYN\_ESC\_REG\_DC\_SYSTEM\_OFFSET**](syn__ethercat_8h.md#define-syn_esc_reg_dc_system_offset)  `0x0920U`<br> |
| define  | [**SYN\_ESC\_REG\_DC\_SYSTEM\_TIME**](syn__ethercat_8h.md#define-syn_esc_reg_dc_system_time)  `0x0900U`<br> |
| define  | [**SYN\_ESC\_REG\_FMMU0**](syn__ethercat_8h.md#define-syn_esc_reg_fmmu0)  `0x0600U`<br> |
| define  | [**SYN\_ESC\_REG\_PDI\_CONTROL**](syn__ethercat_8h.md#define-syn_esc_reg_pdi_control)  `0x0140U`<br> |
| define  | [**SYN\_ESC\_REG\_SII\_EEPROM\_CTRL**](syn__ethercat_8h.md#define-syn_esc_reg_sii_eeprom_ctrl)  `0x0502U`<br> |
| define  | [**SYN\_ESC\_REG\_SM0**](syn__ethercat_8h.md#define-syn_esc_reg_sm0)  `0x0800U`<br> |
| define  | [**SYN\_ESC\_REG\_STATION\_ADDR**](syn__ethercat_8h.md#define-syn_esc_reg_station_addr)  `0x0010U`<br> |
| define  | [**SYN\_ESC\_REG\_STATION\_ALIAS**](syn__ethercat_8h.md#define-syn_esc_reg_station_alias)  `0x0012U`<br> |
| define  | [**SYN\_ESC\_REG\_TYPE**](syn__ethercat_8h.md#define-syn_esc_reg_type)  `0x0000U`<br> |
...
Maximum connected EtherCAT slaves supported 
...
### define SYN\_ESC\_REG\_AL\_CONTROL 
...
### define SYN\_ESC\_REG\_AL\_STATUS 
...
### define SYN\_ESC\_REG\_AL\_STATUS\_CODE 
...
### define SYN\_ESC\_REG\_DC\_SYNC0\_CYCLE 
...
### define SYN\_ESC\_REG\_DC\_SYSTEM\_OFFSET 
...
### define SYN\_ESC\_REG\_DC\_SYSTEM\_TIME 
...
### define SYN\_ESC\_REG\_PDI\_CONTROL 
...
Process Data Interface Control 
...
### define SYN\_ESC\_REG\_SII\_EEPROM\_CTRL 
...
SyncManager 0 Base (8 bytes per SM) 
...
### define SYN\_ESC\_REG\_STATION\_ADDR 
...
### define SYN\_ESC\_REG\_STATION\_ALIAS 
