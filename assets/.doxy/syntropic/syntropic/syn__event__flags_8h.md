...
[**FileList**](files.md) **>** [**sched**](dir_19ac69a9d5854741ebbc92bce8e94ea7.md) **>** [**syn\_event\_flags.h**](syn__event__flags_8h.md)

[Go to the source code of this file](syn__event__flags_8h_source.md)

_32-bit Event Flag Group Synchronization._ [More...](#detailed-description)
...
| Type | Name |
| ---: | :--- |
| struct | [**SYN\_EventFlags**](structSYN__EventFlags.md) <br>_Event Flags Control Structure._  |
...
| Type | Name |
| ---: | :--- |
| enum  | [**SYN\_EventFlagsMode**](#enum-syn_eventflagsmode)  <br> |
...
Provides a bitmask event group mechanism for tasks and protothreads to set, clear, and wait on single or multiple event bit combinations (WAIT\_ALL, WAIT\_ANY, auto-clear). 
