...
| Type | Name |
| ---: | :--- |
|  int | [**hex\_char\_to\_nibble**](#function-hex_char_to_nibble) (char c) <br>_Convert hexadecimal character to 4-bit nibble value._  |
...
_Convert hexadecimal character to 4-bit nibble value._ 
```C++
...
4-bit nibble integer value (0-15), or -1 if invalid. 
