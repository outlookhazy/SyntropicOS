...
[**FileList**](files.md) **>** [**motor**](dir_61470c21c7c2e7c9f977d1e3c2e6c7e0.md) **>** [**syn\_foc\_encoder.h**](syn__foc__encoder_8h.md)

[Go to the source code of this file](syn__foc__encoder_8h_source.md)

_Sensored FOC Rotor Position & Speed Interface (Encoder / Hall / Absolute)._ 
...
| Type | Name |
| ---: | :--- |
| struct | [**SYN\_FOCEncoder**](structSYN__FOCEncoder.md) <br>_Sensored Encoder State._  |
| struct | [**SYN\_FOCEncoderConfig**](structSYN__FOCEncoderConfig.md) <br>_Sensored Encoder Configuration._  |
...
| Type | Name |
| ---: | :--- |
| enum  | [**SYN\_FOCEncoderType**](#enum-syn_focencodertype)  <br>_Sensored Feedback Type._  |
...
### enum SYN\_FOCEncoderType 

_Sensored Feedback Type._ 
```C++
enum SYN_FOCEncoderType {
