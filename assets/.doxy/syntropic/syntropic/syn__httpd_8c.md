...
_Minimal HTTP/1.1 server implementation._ 
...
|  void | [**handle\_client**](#function-handle_client) ([**SYN\_Httpd**](structSYN__Httpd.md) \* srv, [**SYN\_Socket**](syn__port__socket_8h.md#typedef-syn_socket) client) <br>_Handle a single accepted client connection._  |
...
|  int | [**parse\_request**](#function-parse_request) ([**SYN\_Socket**](syn__port__socket_8h.md#typedef-syn_socket) sock, [**SYN\_HttpdRequest**](structSYN__HttpdRequest.md) \* req, uint8\_t \* buf, size\_t buf\_size) <br>_Read and parse the HTTP request line + headers._  |
|  uint32\_t | [**parse\_uint**](#function-parse_uint) (const char \* s) <br>_Parse a decimal integer from a string._  |
...
| Type | Name |
| ---: | :--- |
| define  | [**HTTPD\_ACCEPT\_TIMEOUT\_MS**](syn__httpd_8c.md#define-httpd_accept_timeout_ms)  `100`<br> |
| define  | [**HTTPD\_RECV\_TIMEOUT\_MS**](syn__httpd_8c.md#define-httpd_recv_timeout_ms)  `5000`<br> |
...
_Handle a single accepted client connection._ 
```C++
...
_Read and parse the HTTP request line + headers._ 
```C++
...
* `buf` Work buffer for receiving data. 
* `buf_size` Size of work buffer. 
...
### define HTTPD\_ACCEPT\_TIMEOUT\_MS 

```C++
#define HTTPD_ACCEPT_TIMEOUT_MS `100`
```



Accept poll timeout (ms) 
...
### define HTTPD\_RECV\_TIMEOUT\_MS 
...
Receive timeout per request (ms) 
