...
[**FileList**](files.md) **>** [**src**](dir_68267d1309a1af8e8297ef4c3efbcdba.md) **>** [**syntropic**](dir_d9e327fea148db8a6993543717219dae.md) **>** [**ui**](dir_5167a572f0687ac609ba099b941e0ec0.md) **>** [**syn\_imgui.h**](syn__imgui_8h.md)

[Go to the source code of this file](syn__imgui_8h_source.md)

_Lightweight, zero-allocation Immediate Mode GUI (IMGUI) for embedded systems._ [More...](#detailed-description)
...
| Type | Name |
| ---: | :--- |
| struct | [**SYN\_IMGUI\_Context**](structSYN__IMGUI__Context.md) <br>_Immediate-mode GUI context — inputs, navigation, style, layout._  |
| struct | [**SYN\_IMGUI\_Layout**](structSYN__IMGUI__Layout.md) <br>_Auto-layout state. Managed by syn\_imgui\_layout\_begin/end._  |
| struct | [**SYN\_IMGUI\_Scroll**](structSYN__IMGUI__Scroll.md) <br>_Scroll region state for scrollable IMGUI panels._  |
| struct | [**SYN\_IMGUI\_Style**](structSYN__IMGUI__Style.md) <br>_Visual style parameters for IMGUI widgets._  |
...
|  int | [**syn\_imgui\_numpad**](#function-syn_imgui_numpad) ([**SYN\_IMGUI\_Context**](structSYN__IMGUI__Context.md) \* ctx, char \* buffer, size\_t max\_len, [**bool**](syn__defs_8h.md#enum-bool) mask\_input, int16\_t x, int16\_t y, int16\_t w, int16\_t h) <br>_Render and handle a 4x3 virtual numeric PIN keypad widget._  |
...
|  [**bool**](syn__defs_8h.md#enum-bool) | [**syn\_imgui\_toast**](#function-syn_imgui_toast) ([**SYN\_IMGUI\_Context**](structSYN__IMGUI__Context.md) \* ctx, const char \* message, uint32\_t duration\_ms, uint32\_t current\_tick\_ms, uint32\_t start\_tick\_ms) <br>_Render a transient notification toast banner._  |
...
| Type | Name |
| ---: | :--- |
| define  | [**SYN\_IMGUI\_MAX\_ROW\_COLS**](syn__imgui_8h.md#define-syn_imgui_max_row_cols)  `8`<br>_Maximum number of columns in a layout\_row call._  |
...
### function syn\_imgui\_numpad 

_Render and handle a 4x3 virtual numeric PIN keypad widget._ 
```C++
int syn_imgui_numpad (
    SYN_IMGUI_Context * ctx,
    char * buffer,
    size_t max_len,
    bool mask_input,
...
Displays a 4x3 keypad grid (digits 0-9, CLEAR 'C', OK). Touch taps or encoder navigation append digits to `buffer` up to `max_len` - 1.
...
* `ctx` Context. 
* `buffer` Caller-owned char array for digits (null-terminated). 
* `max_len` Capacity of buffer (including null terminator). 
* `mask_input` If true, display digits as '\*' for security PIN entry. 
* `x` Position and size (0 = auto-layout). 



**Returns:**

1 if OK was pressed, -1 if CLEAR/Cancel was pressed, 0 if still editing. 
...
### function syn\_imgui\_toast 

_Render a transient notification toast banner._ 
```C++
bool syn_imgui_toast (
    SYN_IMGUI_Context * ctx,
    const char * message,
...
Draws a floating notification overlay banner at the top of the display. Auto-dismisses when (current\_tick\_ms - start\_tick\_ms) &gt;= duration\_ms.
...
* `current_tick_ms` Current millisecond tick count. 
* `start_tick_ms` Millisecond tick when the toast was posted. 



**Returns:**

true if the toast is currently visible, false if expired. 
...
### define SYN\_IMGUI\_MAX\_ROW\_COLS 

_Maximum number of columns in a layout\_row call._ 
```C++
