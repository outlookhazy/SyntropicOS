...
[**FileList**](files.md) **>** [**motor**](dir_61470c21c7c2e7c9f977d1e3c2e6c7e0.md) **>** [**syn\_interpolator.h**](syn__interpolator_8h.md)

[Go to the source code of this file](syn__interpolator_8h_source.md)

_Coordinated multi-axis linear & circular arc trajectory interpolator._ [More...](#detailed-description)
...
| Type | Name |
| ---: | :--- |
| struct | [**SYN\_Interpolator**](structSYN__Interpolator.md) <br>_Multi-Axis Interpolator configuration and state machine._  |
| struct | [**SYN\_Vector3F**](structSYN__Vector3F.md) <br>_3D Vector position in steps or user units_  |
...
| Type | Name |
| ---: | :--- |
| enum  | [**SYN\_Interp\_Mode**](#enum-syn_interp_mode)  <br>_Interpolation mode enum._  |
...
|  [**SYN\_Status**](syn__defs_8h.md#enum-syn_status) | [**syn\_interpolator\_plan\_bezier**](#function-syn_interpolator_plan_bezier) ([**SYN\_Interpolator**](structSYN__Interpolator.md) \* interp, [**SYN\_Vector3F**](structSYN__Vector3F.md) p0, [**SYN\_Vector3F**](structSYN__Vector3F.md) p1, [**SYN\_Vector3F**](structSYN__Vector3F.md) p2, [**SYN\_Vector3F**](structSYN__Vector3F.md) p3, float feedrate, float max\_accel, float max\_jerk, float step\_res) <br>_Plan a Cubic 3D Bezier curve trajectory._  |
...
### enum SYN\_Interp\_Mode 

_Interpolation mode enum._ 
```C++
...
### function syn\_interpolator\_plan\_bezier 

_Plan a Cubic 3D Bezier curve trajectory._ 
```C++
