...
| typedef void(\* | [**SYN\_LogOutputFn**](#typedef-syn_logoutputfn)  <br>_Output function signature for custom log backends (e.g. UART, ITM, RTT, file)._  |
...
|  void | [**syn\_log\_init\_backend**](#function-syn_log_init_backend) ([**SYN\_LogOutputFn**](syn__log_8h.md#typedef-syn_logoutputfn) output\_fn, [**SYN\_LogLevel**](syn__log_8h.md#enum-syn_loglevel) min\_level) <br>_Core log initialization implementation function._  |
...
| define  | [**syn\_log\_init**](syn__log_8h.md#define-syn_log_init) (...) `\_SYN\_LOG\_INIT\_GET\_MACRO(\_\_VA\_ARGS\_\_, \_SYN\_LOG\_INIT\_2, \_SYN\_LOG\_INIT\_1)(\_\_VA\_ARGS\_\_)`<br>_Initialize the logging system._  |
...
### typedef SYN\_LogOutputFn 

_Output function signature for custom log backends (e.g. UART, ITM, RTT, file)._ 
```C++
...
### function syn\_log\_init\_backend 

_Core log initialization implementation function._ 
```C++
void syn_log_init_backend (
    SYN_LogOutputFn output_fn,
...
Use [**syn\_log\_init()**](syn__log_8h.md#define-syn_log_init) macro which supports both:
* [**syn\_log\_init(min\_level)**](syn__log_8h.md#define-syn_log_init)
* [**syn\_log\_init(output\_fn, min\_level)**](syn__log_8h.md#define-syn_log_init)
...
* `output_fn` Custom output function pointer (or NULL for default port output). 
* `min_level` Minimum log level threshold for log emission. 
...
Supports 1 argument (min\_level) or 2 arguments (output\_fn, min\_level). 
