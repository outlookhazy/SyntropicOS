...
[**FileList**](files.md) **>** [**src**](dir_68267d1309a1af8e8297ef4c3efbcdba.md) **>** [**syntropic**](dir_d9e327fea148db8a6993543717219dae.md) **>** [**util**](dir_2b7a0faa62b8c8b128527d3a000d1ad9.md) **>** [**syn\_matrix.h**](syn__matrix_8h.md)

[Go to the source code of this file](syn__matrix_8h_source.md)

_Fixed-point Q16.16 matrix operations — zero heap allocation._ [More...](#detailed-description)
...
| Type | Name |
| ---: | :--- |
| struct | [**SYN\_Matrix**](structSYN__Matrix.md) <br>_Fixed-point matrix descriptor (non-owning view)._  |
...
|  [**SYN\_Status**](syn__defs_8h.md#enum-syn_status) | [**syn\_matrix\_inv\_3x3**](#function-syn_matrix_inv_3x3) (const [**SYN\_Matrix**](structSYN__Matrix.md) \* src, [**SYN\_Matrix**](structSYN__Matrix.md) \* dst) <br>_Invert a 3×3 matrix in-place or out-of-place via Cramer's rule._  |
|  [**SYN\_Status**](syn__defs_8h.md#enum-syn_status) | [**syn\_matrix\_inv\_lu**](#function-syn_matrix_inv_lu) (const [**SYN\_Matrix**](structSYN__Matrix.md) \* src, [**SYN\_Matrix**](structSYN__Matrix.md) \* dst) <br>_Invert an arbitrary N×N matrix via LU decomposition (convenience wrapper)._  |
|  [**SYN\_Status**](syn__defs_8h.md#enum-syn_status) | [**syn\_matrix\_inv\_lu\_work**](#function-syn_matrix_inv_lu_work) (const [**SYN\_Matrix**](structSYN__Matrix.md) \* src, [**SYN\_Matrix**](structSYN__Matrix.md) \* dst, [**q16\_t**](syn__qmath_8h.md#typedef-q16_t) \* lu\_work, uint8\_t \* p\_work, [**q16\_t**](syn__qmath_8h.md#typedef-q16_t) \* col\_work) <br>_Invert an arbitrary N×N matrix via LU decomposition using caller-supplied workspace._  |
...
|  [**SYN\_Status**](syn__defs_8h.md#enum-syn_status) | [**syn\_matrix\_least\_squares\_work**](#function-syn_matrix_least_squares_work) (const [**SYN\_Matrix**](structSYN__Matrix.md) \* A, const [**SYN\_Matrix**](structSYN__Matrix.md) \* b, [**SYN\_Matrix**](structSYN__Matrix.md) \* x, [**q16\_t**](syn__qmath_8h.md#typedef-q16_t) \* ata\_work, [**q16\_t**](syn__qmath_8h.md#typedef-q16_t) \* atb\_work, [**q16\_t**](syn__qmath_8h.md#typedef-q16_t) \* at\_work, [**q16\_t**](syn__qmath_8h.md#typedef-q16_t) \* solver\_lu, [**q16\_t**](syn__qmath_8h.md#typedef-q16_t) \* solver\_y) <br>_Solve overdetermined system A · x ≈ b via Least Squares using caller-supplied workspace._  |
...
|  [**SYN\_Status**](syn__defs_8h.md#enum-syn_status) | [**syn\_matrix\_solve\_cholesky**](#function-syn_matrix_solve_cholesky) (const [**SYN\_Matrix**](structSYN__Matrix.md) \* A, const [**SYN\_Matrix**](structSYN__Matrix.md) \* b, [**SYN\_Matrix**](structSYN__Matrix.md) \* x) <br>_Solve symmetric positive-definite system A · x = b via Cholesky (convenience wrapper)._  |
|  [**SYN\_Status**](syn__defs_8h.md#enum-syn_status) | [**syn\_matrix\_solve\_cholesky\_work**](#function-syn_matrix_solve_cholesky_work) (const [**SYN\_Matrix**](structSYN__Matrix.md) \* A, const [**SYN\_Matrix**](structSYN__Matrix.md) \* b, [**SYN\_Matrix**](structSYN__Matrix.md) \* x, [**q16\_t**](syn__qmath_8h.md#typedef-q16_t) \* L\_work, [**q16\_t**](syn__qmath_8h.md#typedef-q16_t) \* y\_work) <br>_Solve system A · x = b via Cholesky decomposition using caller-supplied workspace buffer._  |
|  [**SYN\_Status**](syn__defs_8h.md#enum-syn_status) | [**syn\_matrix\_solve\_lu**](#function-syn_matrix_solve_lu) (const [**SYN\_Matrix**](structSYN__Matrix.md) \* A, const [**SYN\_Matrix**](structSYN__Matrix.md) \* b, [**SYN\_Matrix**](structSYN__Matrix.md) \* x) <br>_Solve system A · x = b via LU decomposition (convenience wrapper)._  |
|  [**SYN\_Status**](syn__defs_8h.md#enum-syn_status) | [**syn\_matrix\_solve\_lu\_work**](#function-syn_matrix_solve_lu_work) (const [**SYN\_Matrix**](structSYN__Matrix.md) \* A, const [**SYN\_Matrix**](structSYN__Matrix.md) \* b, [**SYN\_Matrix**](structSYN__Matrix.md) \* x, [**q16\_t**](syn__qmath_8h.md#typedef-q16_t) \* lu\_work, uint8\_t \* p\_work, [**q16\_t**](syn__qmath_8h.md#typedef-q16_t) \* y\_work) <br>_Solve system A · x = b via LU decomposition using caller-supplied workspace buffer._  |
...
| Type | Name |
| ---: | :--- |
| define  | [**SYN\_MAT2\_DECL**](syn__matrix_8h.md#define-syn_mat2_decl) (name) `[**SYN\_MAT\_DECL**](syn__matrix_8h.md#define-syn_mat_decl)(name, 2, 2)`<br>_Shorthand for 2×2._  |
| define  | [**SYN\_MAT3\_DECL**](syn__matrix_8h.md#define-syn_mat3_decl) (name) `[**SYN\_MAT\_DECL**](syn__matrix_8h.md#define-syn_mat_decl)(name, 3, 3)`<br>_Shorthand for 3×3._  |
| define  | [**SYN\_MAT4\_DECL**](syn__matrix_8h.md#define-syn_mat4_decl) (name) `[**SYN\_MAT\_DECL**](syn__matrix_8h.md#define-syn_mat_decl)(name, 4, 4)`<br>_Shorthand for 4×4._  |
| define  | [**SYN\_MAT\_AT**](syn__matrix_8h.md#define-syn_mat_at) (m, r, c) `((m)-&gt;data[(r) \* (m)-&gt;cols + (c)])`<br>_Element access (row, col) — evaluates to an lvalue._  |
| define  | [**SYN\_MAT\_DECL**](syn__matrix_8h.md#define-syn_mat_decl) (name, R, C) `/* multi line expression */`<br>_Declare a matrix with automatic (stack) storage._  |
| define  | [**SYN\_MAT\_INIT**](syn__matrix_8h.md#define-syn_mat_init) (name, storage, R, C) `[**SYN\_Matrix**](structSYN__Matrix.md) name = {(storage), (R), (C)}`<br>_Initialize a matrix view over existing storage._  |
| define  | [**SYN\_MAT\_STATIC**](syn__matrix_8h.md#define-syn_mat_static) (name, R, C) `/* multi line expression */`<br>_Declare a matrix with static storage (zero-initialized)._  |
| define  | [**SYN\_SOLVER\_MAX\_N**](syn__matrix_8h.md#define-syn_solver_max_n)  `8`<br>_Maximum matrix dimension N for general linear solvers (LU, Cholesky, LS)_  |
...
### function syn\_matrix\_inv\_3x3 

_Invert a 3×3 matrix in-place or out-of-place via Cramer's rule._ 
```C++
...
SYN\_OK on success, SYN\_ERROR if matrix is singular (det == 0). 
...
### function syn\_matrix\_inv\_lu 

_Invert an arbitrary N×N matrix via LU decomposition (convenience wrapper)._ 
```C++
...
SYN\_OK on success, SYN\_ERROR if src is singular or dimensions invalid. 
...
### function syn\_matrix\_inv\_lu\_work 

_Invert an arbitrary N×N matrix via LU decomposition using caller-supplied workspace._ 
```C++
...
### function syn\_matrix\_least\_squares\_work 

_Solve overdetermined system A · x ≈ b via Least Squares using caller-supplied workspace._ 
```C++
...
_Solve symmetric positive-definite system A · x = b via Cholesky (convenience wrapper)._ 
```C++
...
### function syn\_matrix\_solve\_cholesky\_work 

_Solve system A · x = b via Cholesky decomposition using caller-supplied workspace buffer._ 
```C++
...
_Solve system A · x = b via LU decomposition (convenience wrapper)._ 
```C++
...
### function syn\_matrix\_solve\_lu\_work 

_Solve system A · x = b via LU decomposition using caller-supplied workspace buffer._ 
```C++
...
### define SYN\_MAT2\_DECL 

_Shorthand for 2×2._ 
```C++
...
### define SYN\_MAT3\_DECL 

_Shorthand for 3×3._ 
```C++
...
### define SYN\_MAT4\_DECL 

_Shorthand for 4×4._ 
```C++
...
_Element access (row, col) — evaluates to an lvalue._ 
```C++
#define SYN_MAT_AT (
    m,
    r,
...
### define SYN\_MAT\_DECL 

_Declare a matrix with automatic (stack) storage._ 
```C++
#define SYN_MAT_DECL (
    name,
    R,
...
### define SYN\_MAT\_INIT 

_Initialize a matrix view over existing storage._ 
```C++
#define SYN_MAT_INIT (
    name,
    storage,
...
### define SYN\_MAT\_STATIC 

_Declare a matrix with static storage (zero-initialized)._ 
```C++
...
_Maximum matrix dimension N for general linear solvers (LU, Cholesky, LS)_ 
```C++
