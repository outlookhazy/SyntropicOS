...
[**File List**](files.md) **>** [**src**](dir_68267d1309a1af8e8297ef4c3efbcdba.md) **>** [**syntropic**](dir_d9e327fea148db8a6993543717219dae.md) **>** [**util**](dir_2b7a0faa62b8c8b128527d3a000d1ad9.md) **>** [**syn\_metrics.c**](syn__metrics_8c.md)

[Go to the documentation of this file](syn__metrics_8c.md)
...
void syn_metrics_record(const char *name, float value)
{
    ...
    if (slen > 0 && slen < (int)sizeof(buf)) {
        syn_router_send(g_metrics_router, 0x01 /* GATEWAY */, 0x04, (const uint8_t *)buf,
                        (uint8_t)slen, false);
    }
}
