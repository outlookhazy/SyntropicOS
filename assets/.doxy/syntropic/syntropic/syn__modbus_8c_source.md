...
[**File List**](files.md) **>** [**proto**](dir_0a7333506e1b11c22e7531106607b850.md) **>** [**syn\_modbus.c**](syn__modbus_8c.md)

[Go to the documentation of this file](syn__modbus_8c.md)
...
{
    if (len < 2)
        return false; /* LCOV_EXCL_LINE: Unreachable guard; caller verifies frame_len >= 4 before
                         CRC verification */
