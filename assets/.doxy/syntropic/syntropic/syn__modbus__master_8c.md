...
| Type | Name |
| ---: | :--- |
|  uint16\_t | [**read\_u16\_be**](#function-read_u16_be) (const uint8\_t \* p) <br>_Read 16-bit unsigned integer in big-endian byte order._  |
...
|  void | [**write\_u16\_be**](#function-write_u16_be) (uint8\_t \* p, uint16\_t val) <br>_Write 16-bit unsigned integer in big-endian byte order._  |
...
_Read 16-bit unsigned integer in big-endian byte order._ 
```C++
...
_Write 16-bit unsigned integer in big-endian byte order._ 
```C++
