...
| struct | [**SYN\_ModbusMasterQuery**](structSYN__ModbusMasterQuery.md) <br>_Modbus Master query descriptor._  |
| struct | [**SYN\_ModbusMasterQueue**](structSYN__ModbusMasterQueue.md) <br>_Modbus Master transaction queue manager._  |
...
| Type | Name |
| ---: | :--- |
| typedef void(\* | [**SYN\_ModbusMasterCallback**](#typedef-syn_modbusmastercallback)  <br>_Modbus Master transaction response callback function pointer type._  |
...
|  void | [**syn\_modbus\_master\_queue\_init**](#function-syn_modbus_master_queue_init) ([**SYN\_ModbusMasterQueue**](structSYN__ModbusMasterQueue.md) \* q, uint8\_t max\_retries) <br>_Initialize a Modbus Master transaction queue._  |
|  [**SYN\_Status**](syn__defs_8h.md#enum-syn_status) | [**syn\_modbus\_master\_queue\_push**](#function-syn_modbus_master_queue_push) ([**SYN\_ModbusMasterQueue**](structSYN__ModbusMasterQueue.md) \* q, const [**SYN\_ModbusMasterQuery**](structSYN__ModbusMasterQuery.md) \* query) <br>_Push a query request into the transaction queue._  |
|  [**SYN\_Status**](syn__defs_8h.md#enum-syn_status) | [**syn\_modbus\_master\_queue\_step**](#function-syn_modbus_master_queue_step) ([**SYN\_ModbusMaster**](structSYN__ModbusMaster.md) \* m, [**SYN\_ModbusMasterQueue**](structSYN__ModbusMasterQueue.md) \* q, uint32\_t now\_ms) <br>_Process queue advancement and dispatch active queries to Master._  |
...
| Type | Name |
| ---: | :--- |
| define  | [**SYN\_MODBUS\_MASTER\_MAX\_READ\_DATA**](syn__modbus__master_8h.md#define-syn_modbus_master_max_read_data)  `250`<br> |
| define  | [**SYN\_MODBUS\_QUEUE\_SIZE**](syn__modbus__master_8h.md#define-syn_modbus_queue_size)  `16`<br> |
...
### typedef SYN\_ModbusMasterCallback 

_Modbus Master transaction response callback function pointer type._ 
```C++
typedef void(* SYN_ModbusMasterCallback) (uint8_t slave_addr, uint8_t func_code, const uint16_t *data, uint16_t count, SYN_Status status, void *user_ctx);
```
...
### function syn\_modbus\_master\_queue\_init 

_Initialize a Modbus Master transaction queue._ 
```C++
void syn_modbus_master_queue_init (
...
* `max_retries` Number of retry attempts on timeout (e.g. 2). 
...
### function syn\_modbus\_master\_queue\_push 

_Push a query request into the transaction queue._ 
```C++
SYN_Status syn_modbus_master_queue_push (
    SYN_ModbusMasterQueue * q,
...
* `q` Pointer to queue. 
* `query` Pointer to query parameters. 



**Returns:**

SYN\_OK on success, SYN\_ERROR if queue is full. 
...
### function syn\_modbus\_master\_queue\_step 

_Process queue advancement and dispatch active queries to Master._ 
```C++
SYN_Status syn_modbus_master_queue_step (
    SYN_ModbusMaster * m,
    SYN_ModbusMasterQueue * q,
    uint32_t now_ms
) 
...
### define SYN\_MODBUS\_MASTER\_MAX\_READ\_DATA 
...
Max response registers or byte values 
...
### define SYN\_MODBUS\_QUEUE\_SIZE 
...
Maximum Modbus master query queue capacity (16) 
