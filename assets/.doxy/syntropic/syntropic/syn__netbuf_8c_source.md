...
[**File List**](files.md) **>** [**src**](dir_68267d1309a1af8e8297ef4c3efbcdba.md) **>** [**syntropic**](dir_d9e327fea148db8a6993543717219dae.md) **>** [**util**](dir_2b7a0faa62b8c8b128527d3a000d1ad9.md) **>** [**syn\_netbuf.c**](syn__netbuf_8c.md)

[Go to the documentation of this file](syn__netbuf_8c.md)
...
{
    if (!pool || !bufs || !raw_mem || buf_count == 0 || buf_size == 0)
...
uint8_t *syn_netbuf_push(SYN_NetBuf *buf, size_t len)
{
    if (!buf)
        return NULL;
    if ((size_t)(buf->data - buf->head) < len)
        return NULL;
...
uint8_t *syn_netbuf_pull(SYN_NetBuf *buf, size_t len)
{
    if (!buf)
        return NULL;
    if ((size_t)(buf->tail - buf->data) < len)
        return NULL;
...
uint8_t *syn_netbuf_put(SYN_NetBuf *buf, size_t len)
{
    if (!buf)
        return NULL;
    if ((size_t)(buf->end - buf->tail) < len)
        return NULL;
