...
| Type | Name |
| ---: | :--- |
|  int32\_t | [**syn\_deg\_to\_udeg**](#function-syn_deg_to_udeg) (double deg) <br>_Convert decimal degrees to microdegrees (1e-7 deg)._  |
|  double | [**syn\_udeg\_to\_deg**](#function-syn_udeg_to_deg) (int32\_t udeg) <br>_Convert microdegrees (1e-7 deg) to decimal degrees._  |
...
| Type | Name |
| ---: | :--- |
| define  | [**SYN\_GNSS\_USE\_FIXED\_POINT**](syn__nmea_8h.md#define-syn_gnss_use_fixed_point)  `0`<br> |
| define  | [**SYN\_NMEA\_MAX\_SENTENCE\_LEN**](syn__nmea_8h.md#define-syn_nmea_max_sentence_len)  `82`<br> |
| define  | [**SYN\_NMEA\_USE\_FIXED\_POINT**](syn__nmea_8h.md#define-syn_nmea_use_fixed_point)  `[**SYN\_GNSS\_USE\_FIXED\_POINT**](syn__nmea_8h.md#define-syn_gnss_use_fixed_point)`<br> |
...
### function syn\_deg\_to\_udeg 

_Convert decimal degrees to microdegrees (1e-7 deg)._ 
```C++
static inline int32_t syn_deg_to_udeg (
    double deg
) 
```
...
* `deg` Decimal degrees input value. 



**Returns:**

Microdegrees (1e-7 deg) equivalent. 
...
### function syn\_udeg\_to\_deg 

_Convert microdegrees (1e-7 deg) to decimal degrees._ 
```C++
static inline double syn_udeg_to_deg (
    int32_t udeg
) 
```
...
Enable fixed-point GNSS calculations if non-zero 
...
### define SYN\_NMEA\_USE\_FIXED\_POINT 
