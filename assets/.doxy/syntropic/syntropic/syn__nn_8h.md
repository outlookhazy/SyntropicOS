...
[**FileList**](files.md) **>** [**src**](dir_68267d1309a1af8e8297ef4c3efbcdba.md) **>** [**syntropic**](dir_d9e327fea148db8a6993543717219dae.md) **>** [**util**](dir_2b7a0faa62b8c8b128527d3a000d1ad9.md) **>** [**syn\_nn.h**](syn__nn_8h.md)

[Go to the source code of this file](syn__nn_8h_source.md)

_Zero-heap TinyML Neural Network Engine with Attention & Quantization Scaling._ [More...](#detailed-description)
...
| Type | Name |
| ---: | :--- |
| struct | [**SYN\_NN\_Layer**](structSYN__NN__Layer.md) <br>_Layer Descriptor Struct._  |
| struct | [**SYN\_NN\_Model**](structSYN__NN__Model.md) <br>_Model Descriptor Struct._  |
| struct | [**syn\_nn\_quant\_t**](structsyn__nn__quant__t.md) <br>_Affine Quantization Scaling Parameters (Scale & Zero-Point)._  |
...
| Type | Name |
| ---: | :--- |
| enum  | [**SYN\_NN\_Activation**](#enum-syn_nn_activation)  <br>_Neural Network Activation Functions._  |
| enum  | [**SYN\_NN\_LayerType**](#enum-syn_nn_layertype)  <br>_Layer Type Enum for Declarative Models._  |
...
Implements quantized INT8 (q7\_t) Dense, Attention, Softmax, and Activation functions with zero dynamic memory allocation. 
...
### enum SYN\_NN\_Activation 

_Neural Network Activation Functions._ 
```C++
...
### enum SYN\_NN\_LayerType 

_Layer Type Enum for Declarative Models._ 
```C++
enum SYN_NN_LayerType {
    SYN_NN_LAYER_DENSE = 0,
    SYN_NN_LAYER_ATTENTION
};
```
