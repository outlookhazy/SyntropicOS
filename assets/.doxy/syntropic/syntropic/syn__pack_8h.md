...
|  void | [**syn\_pack\_u64**](#function-syn_pack_u64) (uint8\_t \* buf, size\_t \* pos, uint64\_t val) <br>_Pack a uint64\_t value (Big Endian)._  |
|  void | [**syn\_pack\_u64\_le**](#function-syn_pack_u64_le) (uint8\_t \* buf, size\_t \* pos, uint64\_t val) <br>_Pack a uint64\_t value (Little Endian)._  |
...
|  uint16\_t | [**syn\_peek\_u16\_le**](#function-syn_peek_u16_le) (const uint8\_t \* buf, size\_t pos) <br>_Peek a uint16\_t value (Little Endian) without advancing position._  |
...
|  uint32\_t | [**syn\_peek\_u32\_le**](#function-syn_peek_u32_le) (const uint8\_t \* buf, size\_t pos) <br>_Peek a uint32\_t value (Little Endian) without advancing position._  |
...
|  void | [**syn\_poke\_u16**](#function-syn_poke_u16) (uint16\_t val, uint8\_t \* buf, size\_t pos) <br>_Poke a uint16\_t value (Big Endian) at a fixed offset._  |
|  void | [**syn\_poke\_u16\_le**](#function-syn_poke_u16_le) (uint16\_t val, uint8\_t \* buf, size\_t pos) <br>_Poke a uint16\_t value (Little Endian) at a fixed offset._  |
|  void | [**syn\_poke\_u32**](#function-syn_poke_u32) (uint32\_t val, uint8\_t \* buf, size\_t pos) <br>_Poke a uint32\_t value (Big Endian) at a fixed offset._  |
|  void | [**syn\_poke\_u32\_le**](#function-syn_poke_u32_le) (uint32\_t val, uint8\_t \* buf, size\_t pos) <br>_Poke a uint32\_t value (Little Endian) at a fixed offset._  |
...
|  uint64\_t | [**syn\_unpack\_u64**](#function-syn_unpack_u64) (const uint8\_t \* buf, size\_t \* pos) <br>_Unpack a uint64\_t value (Big Endian)._  |
|  uint64\_t | [**syn\_unpack\_u64\_le**](#function-syn_unpack_u64_le) (const uint8\_t \* buf, size\_t \* pos) <br>_Unpack a uint64\_t value (Little Endian)._  |
...
### function syn\_pack\_u64 

_Pack a uint64\_t value (Big Endian)._ 
```C++
...
### function syn\_pack\_u64\_le 

_Pack a uint64\_t value (Little Endian)._ 
```C++
...
### function syn\_peek\_u16\_le 

_Peek a uint16\_t value (Little Endian) without advancing position._ 
```C++
...
### function syn\_peek\_u32\_le 

_Peek a uint32\_t value (Little Endian) without advancing position._ 
```C++
...
### function syn\_poke\_u16 

_Poke a uint16\_t value (Big Endian) at a fixed offset._ 
```C++
...
### function syn\_poke\_u16\_le 

_Poke a uint16\_t value (Little Endian) at a fixed offset._ 
```C++
...
### function syn\_poke\_u32 

_Poke a uint32\_t value (Big Endian) at a fixed offset._ 
```C++
...
### function syn\_poke\_u32\_le 

_Poke a uint32\_t value (Little Endian) at a fixed offset._ 
```C++
...
### function syn\_unpack\_u64 

_Unpack a uint64\_t value (Big Endian)._ 
```C++
...
### function syn\_unpack\_u64\_le 

_Unpack a uint64\_t value (Little Endian)._ 
```C++
