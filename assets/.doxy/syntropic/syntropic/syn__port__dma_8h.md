...
|  uint32\_t | [**syn\_port\_dma\_get\_counter**](#function-syn_port_dma_get_counter) (uint8\_t channel\_id) <br>_Get remaining transfer counter for hardware DMA channel._  |
...
### function syn\_port\_dma\_get\_counter 

_Get remaining transfer counter for hardware DMA channel._ 
```C++
