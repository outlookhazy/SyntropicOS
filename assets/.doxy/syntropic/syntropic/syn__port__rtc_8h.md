...
|  [**SYN\_Status**](syn__defs_8h.md#enum-syn_status) | [**syn\_port\_rtc\_set\_alarm**](#function-syn_port_rtc_set_alarm) (const [**SYN\_RTC\_DateTime**](structSYN__RTC__DateTime.md) \* dt) <br>_Set hardware RTC alarm target date/time for low-power wakeup._  |
|  void | [**syn\_port\_rtc\_set\_drift\_ppm**](#function-syn_port_rtc_set_drift_ppm) (int32\_t drift\_ppm) <br>_Set the hardware/software RTC clock drift compensation in PPM._  |
...
### function syn\_port\_rtc\_set\_alarm 

_Set hardware RTC alarm target date/time for low-power wakeup._ 
```C++
SYN_Status syn_port_rtc_set_alarm (
    const SYN_RTC_DateTime * dt
) 
```
...
### function syn\_port\_rtc\_set\_drift\_ppm 

_Set the hardware/software RTC clock drift compensation in PPM._ 
```C++
void syn_port_rtc_set_drift_ppm (
    int32_t drift_ppm
) 
```
