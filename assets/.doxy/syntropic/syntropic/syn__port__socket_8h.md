...
|  [**bool**](syn__defs_8h.md#enum-bool) | [**syn\_port\_sock\_readable**](#function-syn_port_sock_readable) ([**SYN\_Socket**](syn__port__socket_8h.md#typedef-syn_socket) sock) <br>_Check if a TCP socket has data available for reading._  |
...
|  [**bool**](syn__defs_8h.md#enum-bool) | [**syn\_port\_udp\_readable**](#function-syn_port_udp_readable) ([**SYN\_Socket**](syn__port__socket_8h.md#typedef-syn_socket) sock) <br>_Check if a UDP socket has a datagram available._  |
...
### function syn\_port\_sock\_readable 

_Check if a TCP socket has data available for reading._ 
```C++
bool syn_port_sock_readable (
    SYN_Socket sock
) 
```
...
true if readable without blocking, false otherwise. 
...
### function syn\_port\_udp\_readable 

_Check if a UDP socket has a datagram available._ 
```C++
bool syn_port_udp_readable (
    SYN_Socket sock
) 
```
