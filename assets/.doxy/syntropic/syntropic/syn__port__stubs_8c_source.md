...
[**File List**](files.md) **>** [**port\_stubs**](dir_faf66d44489c906207a31f15a9acbcc2.md) **>** [**syn\_port\_stubs.c**](syn__port__stubs_8c.md)

[Go to the documentation of this file](syn__port__stubs_8c.md)
...
SYN_WEAK SYN_Status syn_port_i2c_write_read(uint8_t bus, uint8_t addr, const uint8_t *tx_data,
...
SYN_WEAK bool syn_port_can_send(uint8_t port, uint32_t id, bool extended, const uint8_t *data,
                                uint8_t dlc)
{
    (void)port;
    (void)id;
...
SYN_WEAK bool syn_port_can_receive(uint8_t port, uint32_t *id, bool *extended, uint8_t *data,
                                   uint8_t *dlc)
{
    (void)port;
    (void)id;
...
SYN_WEAK SYN_Status syn_port_dma_start(const SYN_PortDmaTransfer *xfer)
{
    (void)xfer;
    syn_assert_failed(__FILE__, __LINE__);
    return SYN_NOT_IMPLEMENTED;
...
SYN_WEAK SYN_Status syn_port_dma_stop(uint8_t channel_id)
{
    (void)channel_id;
    syn_assert_failed(__FILE__, __LINE__);
    return SYN_NOT_IMPLEMENTED;
...
SYN_WEAK bool syn_port_dma_is_busy(uint8_t channel_id)
{
    (void)channel_id;
    syn_assert_failed(__FILE__, __LINE__);
    return false;
...
SYN_WEAK uint32_t syn_port_dma_get_counter(uint8_t channel_id)
{
    (void)channel_id;
    syn_assert_failed(__FILE__, __LINE__);
    return 0;
