...
[**FileList**](files.md) **>** [**sensor**](dir_3ec96d4fdb788c01e7dd1ddb7db4104c.md) **>** [**syn\_powermon.h**](syn__powermon_8h.md)

[Go to the source code of this file](syn__powermon_8h_source.md)
...
| Type | Name |
| ---: | :--- |
| struct | [**SYN\_PowerMon**](structSYN__PowerMon.md) <br>_Generic Power Monitor Instance Context._  |
...
| Type | Name |
| ---: | :--- |
| enum  | [**SYN\_PowerMonType**](#enum-syn_powermontype)  <br>_Power Monitor IC Type._  |
...
### enum SYN\_PowerMonType 

_Power Monitor IC Type._ 
```C++
enum SYN_PowerMonType {
