...
|  int32\_t | [**s\_drift\_ppm**](#variable-s_drift_ppm)   = `0`<br>_Calibrated clock drift compensation in parts-per-million (PPM)._  |
...
|  [**SYN\_Status**](syn__defs_8h.md#enum-syn_status) | [**syn\_rtc\_schedule\_alarm\_seconds**](#function-syn_rtc_schedule_alarm_seconds) (uint32\_t seconds\_from\_now, [**SYN\_RTC\_DateTime**](structSYN__RTC__DateTime.md) \* alarm\_dt) <br>_Schedule an alarm relative to current time by seconds._  |
...
|  [**SYN\_Status**](syn__defs_8h.md#enum-syn_status) | [**syn\_rtc\_set\_alarm**](#function-syn_rtc_set_alarm) (const [**SYN\_RTC\_DateTime**](structSYN__RTC__DateTime.md) \* dt) <br>_Set the target alarm date/time on the RTC._  |
...
### variable s\_drift\_ppm 

_Calibrated clock drift compensation in parts-per-million (PPM)._ 
```C++
int32_t s_drift_ppm;
```
...
### function syn\_rtc\_schedule\_alarm\_seconds 

_Schedule an alarm relative to current time by seconds._ 
```C++
...
### function syn\_rtc\_set\_alarm 

_Set the target alarm date/time on the RTC._ 
```C++
