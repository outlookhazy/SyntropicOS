...
|  void | [**syn\_port\_spi\_cs\_assert**](#function-syn_port_spi_cs_assert) (uint8\_t spi\_bus, [**SYN\_GPIO\_Pin**](syn__defs_8h.md#typedef-syn_gpio_pin) cs) <br>_Assert SPI Chip Select pin (active low)._  |
|  void | [**syn\_port\_spi\_cs\_deassert**](#function-syn_port_spi_cs_deassert) (uint8\_t spi\_bus, [**SYN\_GPIO\_Pin**](syn__defs_8h.md#typedef-syn_gpio_pin) cs) <br>_Deassert SPI Chip Select pin (idle high)._  |
...
_Assert SPI Chip Select pin (active low)._ 
```C++
static inline void syn_port_spi_cs_assert (
    uint8_t spi_bus,
    SYN_GPIO_Pin cs
) 
```
...
_Deassert SPI Chip Select pin (idle high)._ 
```C++
static inline void syn_port_spi_cs_deassert (
    uint8_t spi_bus,
    SYN_GPIO_Pin cs
) 
```
