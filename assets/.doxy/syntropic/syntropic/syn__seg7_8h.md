...
[**FileList**](files.md) **>** [**display**](dir_572b98f20fe1ab62e971e24ddc7f0bdb.md) **>** [**syn\_seg7.h**](syn__seg7_8h.md)

[Go to the source code of this file](syn__seg7_8h_source.md)
...
| Type | Name |
| ---: | :--- |
| struct | [**SYN\_Seg7**](structSYN__Seg7.md) <br>_7-Segment Display Instance Context._  |
...
| Type | Name |
| ---: | :--- |
| enum  | [**SYN\_Seg7Type**](#enum-syn_seg7type)  <br>_7-segment display wiring polarity._  |
...
| Type | Name |
| ---: | :--- |
| define  | [**SYN\_SEG7\_MAX\_DIGITS**](syn__seg7_8h.md#define-syn_seg7_max_digits)  `8`<br> |
...
_7-segment display wiring polarity._ 
```C++
enum SYN_Seg7Type {
...
Maximum supported display digits (8) 
