...
[**FileList**](files.md) **>** [**sensor**](dir_3ec96d4fdb788c01e7dd1ddb7db4104c.md) **>** [**syn\_sensor\_fusion.c**](syn__sensor__fusion_8c.md)

[Go to the source code of this file](syn__sensor__fusion_8c_source.md)

_6-DOF IMU Mahony Sensor Fusion & AHRS Filter implementation._ 
...
|  [**SYN\_Status**](syn__defs_8h.md#enum-syn_status) | [**syn\_sensor\_fusion\_update\_9dof**](#function-syn_sensor_fusion_update_9dof) ([**SYN\_SensorFusion**](structSYN__SensorFusion.md) \* f, [**q16\_t**](syn__qmath_8h.md#typedef-q16_t) gx, [**q16\_t**](syn__qmath_8h.md#typedef-q16_t) gy, [**q16\_t**](syn__qmath_8h.md#typedef-q16_t) gz, [**q16\_t**](syn__qmath_8h.md#typedef-q16_t) ax, [**q16\_t**](syn__qmath_8h.md#typedef-q16_t) ay, [**q16\_t**](syn__qmath_8h.md#typedef-q16_t) az, [**q16\_t**](syn__qmath_8h.md#typedef-q16_t) mx, [**q16\_t**](syn__qmath_8h.md#typedef-q16_t) my, [**q16\_t**](syn__qmath_8h.md#typedef-q16_t) mz) <br>_Update orientation estimate using 9-axis IMU + Magnetometer sample._  |
...
### function syn\_sensor\_fusion\_update\_9dof 

_Update orientation estimate using 9-axis IMU + Magnetometer sample._ 
```C++
SYN_Status syn_sensor_fusion_update_9dof (
    SYN_SensorFusion * f,
    q16_t gx,
    q16_t gy,
    q16_t gz,
...
Fuses 3-axis gyroscope, 3-axis accelerometer, and 3-axis magnetometer measurements to compute drift-compensated quaternion orientation with absolute magnetic north heading.
...
* `gy` Gyroscope Y rate in rad/s (Q16.16). 
* `gz` Gyroscope Z rate in rad/s (Q16.16). 
* `ax` Accelerometer X acceleration (Q16.16). 
* `ay` Accelerometer Y acceleration (Q16.16). 
* `az` Accelerometer Z acceleration (Q16.16). 
* `mx` Magnetometer X field strength (Q16.16). 
* `my` Magnetometer Y field strength (Q16.16). 
* `mz` Magnetometer Z field strength (Q16.16). 
