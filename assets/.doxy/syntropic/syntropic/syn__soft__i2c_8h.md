...
[**FileList**](files.md) **>** [**drivers**](dir_5897a976633784d8820096ec35a94718.md) **>** [**syn\_soft\_i2c.h**](syn__soft__i2c_8h.md)

[Go to the source code of this file](syn__soft__i2c_8h_source.md)

_Software I2C (bit-banging) driver._ [More...](#detailed-description)
...
| Type | Name |
| ---: | :--- |
| struct | [**SYN\_SoftI2C**](structSYN__SoftI2C.md) <br>_Software I2C instance._  |
...
Implements I2C master functionality using any two GPIO pins. Relies on [**syn\_port\_gpio.h**](syn__port__gpio_8h.md) for pin manipulation. Uses a simple NOP loop for clock stretching/delays. 
