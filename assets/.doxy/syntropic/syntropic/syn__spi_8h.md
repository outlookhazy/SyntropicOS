...
[**FileList**](files.md) **>** [**drivers**](dir_5897a976633784d8820096ec35a94718.md) **>** [**syn\_spi.h**](syn__spi_8h.md)

[Go to the source code of this file](syn__spi_8h_source.md)

_Hardware-decoupled SPI driver supporting Master/Slave roles & full-duplex transfers._ 
...
| Type | Name |
| ---: | :--- |
| struct | [**SYN\_SPI**](structSYN__SPI.md) <br>_SPI driver handle structure._  |
| struct | [**SYN\_SPI\_Config**](structSYN__SPI__Config.md) <br>_SPI driver instance configuration parameters._  |
...
| Type | Name |
| ---: | :--- |
| enum  | [**SYN\_SPI\_Mode**](#enum-syn_spi_mode)  <br>_SPI clock phase and polarity mode._  |
| enum  | [**SYN\_SPI\_Role**](#enum-syn_spi_role)  <br>_SPI operational mode role._  |
...
_SPI clock phase and polarity mode._ 
```C++
enum SYN_SPI_Mode {
    SYN_SPI_MODE_0 = 0,
    SYN_SPI_MODE_1 = 1,
