...
| Type | Name |
| ---: | :--- |
|  size\_t | [**spsc\_advance**](#function-spsc_advance) (size\_t idx, size\_t capacity) <br>_Advance queue circular buffer index._  |
...
_Advance queue circular buffer index._ 
```C++
...
* `idx` Current index. 
* `capacity` Queue buffer capacity. 
