...
[**FileList**](files.md) **>** [**src**](dir_68267d1309a1af8e8297ef4c3efbcdba.md) **>** [**syntropic**](dir_d9e327fea148db8a6993543717219dae.md) **>** [**util**](dir_2b7a0faa62b8c8b128527d3a000d1ad9.md) **>** [**syn\_spsc\_queue.h**](syn__spsc__queue_8h.md)

[Go to the source code of this file](syn__spsc__queue_8h_source.md)

_Lock-free Single-Producer Single-Consumer (SPSC) queue._ [More...](#detailed-description)
...
| Type | Name |
| ---: | :--- |
| struct | [**SYN\_SPSC\_Queue**](structSYN__SPSC__Queue.md) <br>_SPSC Queue Control Structure._  |
...
| Type | Name |
| ---: | :--- |
| define  | [**PT\_BLOCK\_QUEUE\_POP**](syn__spsc__queue_8h.md#define-pt_block_queue_pop) (pt, task, q) `[**PT\_BLOCK\_CONDITION**](syn__pt_8h.md#define-pt_block_condition)(pt, task, ![**syn\_spsc\_queue\_is\_empty**](syn__spsc__queue_8c.md#function-syn_spsc_queue_is_empty)(q))`<br>_Block task execution (SYN\_TASK\_BLOCKED) until SPSC queue is not empty._  |
| define  | [**PT\_QUEUE\_WAIT\_POP**](syn__spsc__queue_8h.md#define-pt_queue_wait_pop) (pt, q) `[**PT\_WAIT\_UNTIL**](syn__pt_8h.md#define-pt_wait_until)(pt, ![**syn\_spsc\_queue\_is\_empty**](syn__spsc__queue_8c.md#function-syn_spsc_queue_is_empty)(q))`<br>_Wait until SPSC queue is not empty (polling)._  |

## Detailed Description


Provides a lock-free, zero-allocation SPSC item queue designed for high-performance ISR-to-Task, Task-to-Task, or Inter-Core (multicore) message passing without spinlocks or disabling interrupts. 
...
### define PT\_BLOCK\_QUEUE\_POP 

_Block task execution (SYN\_TASK\_BLOCKED) until SPSC queue is not empty._ 
```C++
#define PT_BLOCK_QUEUE_POP (
    pt,
    task,
    q
) `PT_BLOCK_CONDITION (pt, task, ! syn_spsc_queue_is_empty (q))`
```
...
### define PT\_QUEUE\_WAIT\_POP 

_Wait until SPSC queue is not empty (polling)._ 
```C++
#define PT_QUEUE_WAIT_POP (
    pt,
    q
) `PT_WAIT_UNTIL (pt, ! syn_spsc_queue_is_empty (q))`
```
