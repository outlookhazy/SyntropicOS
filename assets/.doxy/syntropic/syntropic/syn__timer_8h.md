...
[**FileList**](files.md) **>** [**sched**](dir_19ac69a9d5854741ebbc92bce8e94ea7.md) **>** [**syn\_timer.h**](syn__timer_8h.md)

[Go to the source code of this file](syn__timer_8h_source.md)

_Software timer service — one-shot and periodic timers._ [More...](#detailed-description)
...
| Type | Name |
| ---: | :--- |
| struct | [**SYN\_Timer**](structSYN__Timer.md) <br>_Software timer descriptor._  |
...
| Type | Name |
| ---: | :--- |
| typedef void(\* | [**SYN\_TimerCallback**](#typedef-syn_timercallback)  <br>_Timer expiry callback._  |
...
| Type | Name |
| ---: | :--- |
|  [**bool**](syn__defs_8h.md#enum-bool) | [**syn\_timer\_is\_active**](#function-syn_timer_is_active) (const [**SYN\_Timer**](structSYN__Timer.md) \* timer) <br>_Check if a timer is currently active (running)._  |
...
Timers are caller-owned structs with a callback. They can be used with or without the scheduler. In a bare main loop, call [**syn\_timer\_service()**](syn__timer_8h.md#function-syn_timer_service) each iteration. With the scheduler, run it from a high-priority task.


Timers are driven by [**syn\_port\_get\_tick\_ms()**](syn__port__system_8h.md#function-syn_port_get_tick_ms) — resolution depends on how often you call [**syn\_timer\_service()**](syn__timer_8h.md#function-syn_timer_service).
...
### typedef SYN\_TimerCallback 

_Timer expiry callback._ 
```C++
...
### function syn\_timer\_is\_active 

_Check if a timer is currently active (running)._ 
```C++
static inline bool syn_timer_is_active (
    const SYN_Timer * timer
) 
```
