...
| enum  | [**SYN\_TLS\_CipherSuite**](#enum-syn_tls_ciphersuite)  <br> |
...
| define  | [**SYN\_TLS\_SECRET\_LEN**](syn__tls_8h.md#define-syn_tls_secret_len)  `48U`<br>_Length of TLS 1.3 secret keys in bytes (48 for SHA-384 / SHA-256 capacity)._  |
...
_Length of TLS 1.3 secret keys in bytes (48 for SHA-384 / SHA-256 capacity)._ 
```C++
