...
| define  | [**SYN\_VERSION\_MONTH**](syn__version_8h.md#define-syn_version_month)  `6`<br>_Release month (CalVer)._  |
| define  | [**SYN\_VERSION\_RELEASE**](syn__version_8h.md#define-syn_version_release)  `2`<br>_Release number within the month (CalVer)._  |
