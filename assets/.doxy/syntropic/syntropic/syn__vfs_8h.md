...
|  int | [**syn\_vfs\_rename**](#function-syn_vfs_rename) (const char \* old\_path, const char \* new\_path) <br>_Rename or move a file._  |
|  int32\_t | [**syn\_vfs\_seek**](#function-syn_vfs_seek) (int fd, int32\_t offset, int whence) <br>_Seek in an open file._  |
|  int | [**syn\_vfs\_stat**](#function-syn_vfs_stat) (const char \* path, [**SYN\_VfsDirEnt**](structSYN__VfsDirEnt.md) \* ent) <br>_Get status information for a file or directory._  |
...
|  [**SYN\_Status**](syn__defs_8h.md#enum-syn_status) | [**syn\_vfs\_unmount**](#function-syn_vfs_unmount) (const char \* prefix) <br>_Unmount a filesystem by path prefix._  |
...
### function syn\_vfs\_rename 

_Rename or move a file._ 
```C++
int syn_vfs_rename (
    const char * old_path,
    const char * new_path
...
### function syn\_vfs\_stat 

_Get status information for a file or directory._ 
```C++
int syn_vfs_stat (
    const char * path,
    SYN_VfsDirEnt * ent
...
### function syn\_vfs\_unmount 

_Unmount a filesystem by path prefix._ 
```C++
...
SYN\_OK on success, SYN\_ERROR if not found or busy. 
