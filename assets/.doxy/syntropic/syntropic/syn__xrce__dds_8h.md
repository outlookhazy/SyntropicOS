...
[**FileList**](files.md) **>** [**proto**](dir_0a7333506e1b11c22e7531106607b850.md) **>** [**syn\_xrce\_dds.h**](syn__xrce__dds_8h.md)

[Go to the source code of this file](syn__xrce__dds_8h_source.md)

_Micro-ROS & eProsima Micro XRCE-DDS v1.2 Protocol Client Engine._ [More...](#detailed-description)
...
| Type | Name |
| ---: | :--- |
| struct | [**SYN\_CDR\_Reader**](structSYN__CDR__Reader.md) <br>_CDR deserialization input buffer context._  |
| struct | [**SYN\_CDR\_Writer**](structSYN__CDR__Writer.md) <br>_CDR serialization output buffer context._  |
| struct | [**SYN\_XRCE\_Client**](structSYN__XRCE__Client.md) <br>_Micro XRCE-DDS Client instance context._  |
| struct | [**SYN\_XRCE\_Config**](structSYN__XRCE__Config.md) <br>_Micro XRCE-DDS Client configuration._  |
| struct | [**SYN\_XRCE\_Object**](structSYN__XRCE__Object.md) <br>_Registered XRCE entity tracking record._  |
...
| Type | Name |
| ---: | :--- |
| enum  | [**SYN\_XRCE\_ClientState**](#enum-syn_xrce_clientstate)  <br>_XRCE client connection state._  |
| typedef void(\* | [**SYN\_XRCE\_DataCb**](#typedef-syn_xrce_datacb)  <br>_Callback for incoming topic data from an agent DataReader._  |
| typedef void(\* | [**SYN\_XRCE\_StatusCb**](#typedef-syn_xrce_statuscb)  <br>_Callback for status notifications (entity creation, ack, etc)._  |
...
| Type | Name |
| ---: | :--- |
| define  | [**SYN\_XRCE\_CLIENT\_KEY\_DEFAULT**](syn__xrce__dds_8h.md#define-syn_xrce_client_key_default)  `0xCAFEBABEU`<br> |
| define  | [**SYN\_XRCE\_COOKIE**](syn__xrce__dds_8h.md#define-syn_xrce_cookie)  `0x0100U`<br> |
| define  | [**SYN\_XRCE\_MAX\_OBJECTS**](syn__xrce__dds_8h.md#define-syn_xrce_max_objects)  `16U`<br> |
| define  | [**SYN\_XRCE\_MAX\_TOPIC\_NAME**](syn__xrce__dds_8h.md#define-syn_xrce_max_topic_name)  `64U`<br> |
| define  | [**SYN\_XRCE\_MAX\_TYPE\_NAME**](syn__xrce__dds_8h.md#define-syn_xrce_max_type_name)  `64U`<br> |
| define  | [**SYN\_XRCE\_OBJKIND\_DATAREADER**](syn__xrce__dds_8h.md#define-syn_xrce_objkind_datareader)  `0x06U`<br> |
| define  | [**SYN\_XRCE\_OBJKIND\_DATAWRITER**](syn__xrce__dds_8h.md#define-syn_xrce_objkind_datawriter)  `0x05U`<br> |
| define  | [**SYN\_XRCE\_OBJKIND\_PARTICIPANT**](syn__xrce__dds_8h.md#define-syn_xrce_objkind_participant)  `0x01U`<br> |
| define  | [**SYN\_XRCE\_OBJKIND\_PUBLISHER**](syn__xrce__dds_8h.md#define-syn_xrce_objkind_publisher)  `0x03U`<br> |
| define  | [**SYN\_XRCE\_OBJKIND\_SUBSCRIBER**](syn__xrce__dds_8h.md#define-syn_xrce_objkind_subscriber)  `0x04U`<br> |
| define  | [**SYN\_XRCE\_OBJKIND\_TOPIC**](syn__xrce__dds_8h.md#define-syn_xrce_objkind_topic)  `0x02U`<br> |
| define  | [**SYN\_XRCE\_SESSION\_ID\_DEFAULT**](syn__xrce__dds_8h.md#define-syn_xrce_session_id_default)  `0x81U`<br> |
| define  | [**SYN\_XRCE\_STATUS\_ERR\_ALREADY\_EXISTS**](syn__xrce__dds_8h.md#define-syn_xrce_status_err_already_exists)  `0x11U`<br> |
| define  | [**SYN\_XRCE\_STATUS\_ERR\_INCOMPATIBLE**](syn__xrce__dds_8h.md#define-syn_xrce_status_err_incompatible)  `0x14U`<br> |
| define  | [**SYN\_XRCE\_STATUS\_ERR\_INVALID\_DATA**](syn__xrce__dds_8h.md#define-syn_xrce_status_err_invalid_data)  `0x13U`<br> |
| define  | [**SYN\_XRCE\_STATUS\_ERR\_RESOURCES**](syn__xrce__dds_8h.md#define-syn_xrce_status_err_resources)  `0x15U`<br> |
| define  | [**SYN\_XRCE\_STATUS\_ERR\_UNKNOWN\_REF**](syn__xrce__dds_8h.md#define-syn_xrce_status_err_unknown_ref)  `0x12U`<br> |
| define  | [**SYN\_XRCE\_STATUS\_OK**](syn__xrce__dds_8h.md#define-syn_xrce_status_ok)  `0x00U`<br> |
| define  | [**SYN\_XRCE\_STATUS\_OK\_MATCHED**](syn__xrce__dds_8h.md#define-syn_xrce_status_ok_matched)  `0x01U`<br> |
| define  | [**SYN\_XRCE\_STREAM\_BEST\_EFFORT**](syn__xrce__dds_8h.md#define-syn_xrce_stream_best_effort)  `0x01U`<br> |
| define  | [**SYN\_XRCE\_STREAM\_RELIABLE**](syn__xrce__dds_8h.md#define-syn_xrce_stream_reliable)  `0x80U`<br> |
| define  | [**SYN\_XRCE\_SUBMSG\_ACKNACK**](syn__xrce__dds_8h.md#define-syn_xrce_submsg_acknack)  `0x08U`<br> |
| define  | [**SYN\_XRCE\_SUBMSG\_CREATE**](syn__xrce__dds_8h.md#define-syn_xrce_submsg_create)  `0x01U`<br> |
| define  | [**SYN\_XRCE\_SUBMSG\_CREATE\_CLIENT**](syn__xrce__dds_8h.md#define-syn_xrce_submsg_create_client)  `0x00U`<br> |
| define  | [**SYN\_XRCE\_SUBMSG\_DATA**](syn__xrce__dds_8h.md#define-syn_xrce_submsg_data)  `0x05U`<br> |
| define  | [**SYN\_XRCE\_SUBMSG\_DELETE**](syn__xrce__dds_8h.md#define-syn_xrce_submsg_delete)  `0x02U`<br> |
| define  | [**SYN\_XRCE\_SUBMSG\_HEARTBEAT**](syn__xrce__dds_8h.md#define-syn_xrce_submsg_heartbeat)  `0x07U`<br> |
| define  | [**SYN\_XRCE\_SUBMSG\_READ\_DATA**](syn__xrce__dds_8h.md#define-syn_xrce_submsg_read_data)  `0x04U`<br> |
| define  | [**SYN\_XRCE\_SUBMSG\_STATUS**](syn__xrce__dds_8h.md#define-syn_xrce_submsg_status)  `0x06U`<br> |
| define  | [**SYN\_XRCE\_SUBMSG\_WRITE\_DATA**](syn__xrce__dds_8h.md#define-syn_xrce_submsg_write_data)  `0x03U`<br> |
...
* XRCE-DDS submessage framing (CREATE\_CLIENT, CREATE, WRITE\_DATA, READ\_DATA, DATA, STATUS).
* Full ROS 2 entity tree management (Participant, Topic, Publisher, Subscriber, DataWriter, DataReader).
...
### enum SYN\_XRCE\_ClientState 

_XRCE client connection state._ 
```C++
enum SYN_XRCE_ClientState {
...
### typedef SYN\_XRCE\_DataCb 

_Callback for incoming topic data from an agent DataReader._ 
```C++
typedef void(* SYN_XRCE_DataCb) (uint16_t reader_id, const uint8_t *payload, size_t len, void *user_data);
```
...
* `reader_id` DataReader object ID. 
* `payload` CDR serialized topic payload. 
...
### typedef SYN\_XRCE\_StatusCb 

_Callback for status notifications (entity creation, ack, etc)._ 
```C++
...
* `req_id` Request ID matching the command. 
* `status` XRCE status code (SYN\_XRCE\_STATUS\_OK, etc). 
* `user_data` User context pointer. 
...
### define SYN\_XRCE\_CLIENT\_KEY\_DEFAULT 
...
### define SYN\_XRCE\_MAX\_OBJECTS 
...
Max simultaneously tracked entities 
...
### define SYN\_XRCE\_MAX\_TOPIC\_NAME 
...
### define SYN\_XRCE\_MAX\_TYPE\_NAME 
...
### define SYN\_XRCE\_OBJKIND\_DATAREADER 
...
### define SYN\_XRCE\_OBJKIND\_DATAWRITER 
...
### define SYN\_XRCE\_OBJKIND\_PARTICIPANT 
...
### define SYN\_XRCE\_OBJKIND\_PUBLISHER 
...
### define SYN\_XRCE\_OBJKIND\_SUBSCRIBER 
...
### define SYN\_XRCE\_OBJKIND\_TOPIC 
...
### define SYN\_XRCE\_SESSION\_ID\_DEFAULT 
...
### define SYN\_XRCE\_STATUS\_ERR\_ALREADY\_EXISTS 
...
### define SYN\_XRCE\_STATUS\_ERR\_INCOMPATIBLE 
...
### define SYN\_XRCE\_STATUS\_ERR\_INVALID\_DATA 
...
### define SYN\_XRCE\_STATUS\_ERR\_RESOURCES 
...
### define SYN\_XRCE\_STATUS\_ERR\_UNKNOWN\_REF 
...
Status Error: Unknown reference 
...
### define SYN\_XRCE\_STATUS\_OK\_MATCHED 
...
### define SYN\_XRCE\_STREAM\_BEST\_EFFORT 
...
### define SYN\_XRCE\_STREAM\_RELIABLE 
...
### define SYN\_XRCE\_SUBMSG\_ACKNACK 
...
### define SYN\_XRCE\_SUBMSG\_CREATE 
...
### define SYN\_XRCE\_SUBMSG\_CREATE\_CLIENT 
...
### define SYN\_XRCE\_SUBMSG\_DATA 
...
### define SYN\_XRCE\_SUBMSG\_DELETE 
...
### define SYN\_XRCE\_SUBMSG\_HEARTBEAT 
...
### define SYN\_XRCE\_SUBMSG\_READ\_DATA 
...
### define SYN\_XRCE\_SUBMSG\_STATUS 
...
### define SYN\_XRCE\_SUBMSG\_WRITE\_DATA 
