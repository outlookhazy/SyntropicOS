...
|--------|-------------|----------|
| **Core & Utilities** | Status codes, compiler attributes, assertions, ring buffers, CRC, fixed-point math, lookups, and timeouts. | [Core API](../syntropic/group__syn__core.md) |
...
| **Motor & Control** | DC motors, servos, steppers, actuators, and PID control algorithms. | [Motor API](../syntropic/group__syn__motor.md) |
...
| **DSP & Filters** | Digital signal processing, buffers, FFT, and signal filters (EMA, biquad, median). | [DSP API](../syntropic/group__syn__dsp.md) |
