...
/**
 * @brief Helper function to queue a CAN transmit frame.
 *
 * @param node Pointer to node handle.
 * @param cob_id 11-bit CAN COB-ID.
...
/**
 * @brief Helper function to find an Object Dictionary entry.
 *
 * @param node Pointer to node handle.
